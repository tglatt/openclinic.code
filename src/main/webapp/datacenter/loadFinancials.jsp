...
<div style="float:left;width:45%;display:inline;">
    ...
    <%
        ...
        for(int n=0; n<financials.size(); n++){
            ...
            out.print("<tr><td class='admin'>"+cls+"</td>"+
                       "<td class='admin2'>"+
                        "<a href='javascript:financialGraph(\""+cls+"\",\""+period+"\")'>"+new java.text.DecimalFormat(sFormat).format(Double.parseDouble(financial.split(";")[1]))+" "+sCurrency+"</a>"+
                       "</td>"+
                      "</tr>");
        }
    %>
