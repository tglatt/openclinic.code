        ...
        if(sMapType.equals("mapChart")){
                ...
                */
                ...
                if(sContinent.equalsIgnoreCase("World")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('World');\">"+HTMLEntities.htmlentities(getTran(request,"web","world",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('World');\">"+HTMLEntities.htmlentities(getTran(request,"web","world",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("Africa")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('Africa');\">"+HTMLEntities.htmlentities(getTran(request,"web","africa",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('Africa');\">"+HTMLEntities.htmlentities(getTran(request,"web","africa",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("Middle-East")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('Middle-East');\">"+HTMLEntities.htmlentities(getTran(request,"web","middle-east",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('Middle-East');\">"+HTMLEntities.htmlentities(getTran(request,"web","middle-east",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("Europe")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('Europe');\">"+HTMLEntities.htmlentities(getTran(request,"web","europe",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('Europe');\">"+HTMLEntities.htmlentities(getTran(request,"web","europe",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("North-America")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('North-America');\">"+HTMLEntities.htmlentities(getTran(request,"web","north-america",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('North-America');\">"+HTMLEntities.htmlentities(getTran(request,"web","north-america",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("South-America")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('South-America');\">"+HTMLEntities.htmlentities(getTran(request,"web","south-america",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('South-America');\">"+HTMLEntities.htmlentities(getTran(request,"web","south-america",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("Asia")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('Asia');\">"+HTMLEntities.htmlentities(getTran(request,"web","asia",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('Asia');\">"+HTMLEntities.htmlentities(getTran(request,"web","asia",sWebLanguage))+"</a>\n");
                }
                
                if(sContinent.equalsIgnoreCase("Oceania")){
                    writer.write("<li><b><a href=\"javascript:javascript:showContinent('Oceania');\">"+HTMLEntities.htmlentities(getTran(request,"web","oceania",sWebLanguage))+"</a></b>\n");
                }
                else{
                    writer.write("<li><a href=\"javascript:javascript:showContinent('Oceania');\">"+HTMLEntities.htmlentities(getTran(request,"web","oceania",sWebLanguage))+"</a>\n");
                }
                ...
                writer.write("<div style='font-family:Arial;font-size:8pt;'>"+
             	               deciTotal.format(getTotalValue(servers))+" "+getTranNoLink("web",sParameter,sWebLanguage).toLowerCase()+" "+getTran(request,"web","datacenter.in",sWebLanguage).toLowerCase()+" "+countries.size()+" "+getTran(request,"web","countries",sWebLanguage)+", "+getTran(request,"web","datacenter.in",sWebLanguage).toLowerCase()+" "+getTranNoLink("web",sContinent,sWebLanguage)+
                             "</div>");
