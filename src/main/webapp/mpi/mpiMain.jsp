  ...
  <nav class="nav">
    ...
    <ul class="nav-list" role="navigation">
      <div class="list -left">
        ...
        <li class="item">
          <a style='text-decoration: none;font-family: Raleway, Geneva, sans-serif;' class="link" href="<%=sCONTEXTPATH %>/main.jsp?Page=system/manageOpenCarenetTraffic.jsp&renewalFrequency=5"><img height='24px' style='vertical-align: middle' src='<%=sCONTEXTPATH%>/_img/icons/mobile/icon_config.png'/> <%=getTranNoLink("web","administration",sWebLanguage) %></a>
        </li>
        <%} %>
        <li class="item">
