...
<form name="shortcutForm" method="post">
	...
	<table class="list" cellpadding="0" cellspacing="1">       	    	    
        ...
        <%-- FAST TRANSACTION 6 -----------------------------------------------------------------%>
		<tr>
			<td class='admin'><%=getTran(request,"web","fasttransaction",sWebLanguage)%> 6</td>
			<td class='admin2' colspan='4'>
				<select name="FastTransaction.6" class="text">
                    <option value=""></option>
                    <%
                    	fasttransaction = MedwanQuery.getInstance().getConfigString("quickTransaction6."+activeUser.userid);
	        	        it = v.iterator();
                        while(it.hasNext()){
                            sKey = (String)it.next();
                            sID = (String)hExaminations.get(sKey);
        ...
        <%-- FAST TRANSACTION 7 -----------------------------------------------------------------%>
		<tr>
			<td class='admin'><%=getTran(request,"web","fasttransaction",sWebLanguage)%> 7</td>
			<td class='admin2' colspan='4'>
				<select name="FastTransaction.7" class="text">
                    <option value=""></option>
                    <%
                    	fasttransaction = MedwanQuery.getInstance().getConfigString("quickTransaction7."+activeUser.userid);
	        	        it = v.iterator();
                        while(it.hasNext()){
                            sKey = (String)it.next();
                            sID = (String)hExaminations.get(sKey);
        ...
        <%-- FAST TRANSACTION 8 -----------------------------------------------------------------%>
		<tr>
			<td class='admin'><%=getTran(request,"web","fasttransaction",sWebLanguage)%> 8</td>
			<td class='admin2' colspan='4'>
				<select name="FastTransaction.8" class="text">
                    <option value=""></option>
                    <%
                    	fasttransaction = MedwanQuery.getInstance().getConfigString("quickTransaction8."+activeUser.userid);
	        	        it = v.iterator();
                        while(it.hasNext()){
                            sKey = (String)it.next();
                            sID = (String)hExaminations.get(sKey);
        ...
        <%-- FAST TRANSACTION 9 -----------------------------------------------------------------%>
		<tr>
			<td class='admin'><%=getTran(request,"web","fasttransaction",sWebLanguage)%> 9</td>
			<td class='admin2' colspan='4'>
				<select name="FastTransaction.9" class="text">
                    <option value=""></option>
                    <%
                    	fasttransaction = MedwanQuery.getInstance().getConfigString("quickTransaction9."+activeUser.userid);
	        	        it = v.iterator();
                        while(it.hasNext()){
                            sKey = (String)it.next();
                            sID = (String)hExaminations.get(sKey);
