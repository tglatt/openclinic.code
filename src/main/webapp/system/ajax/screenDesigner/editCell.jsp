...
<%!
    ...
    private String displayItem(ScreenTransactionItem item, String sWebLanguage, int itemIdx){
        ...
        sHtml+= "<td>"+
                 "<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' class='link' name='Item_"+item.getItemTypeId()+"'"+
                  " alt='"+getTranNoLink("web","delete",sWebLanguage)+"'"+
                  " onClick=\"deleteItem('row_"+itemIdx+"')\">&nbsp;"+
                 "<img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' class='link' style='vertical-align:-3px' name='Item_"+item.getItemTypeId()+"'"+
