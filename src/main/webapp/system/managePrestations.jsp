               ...
               <br>
                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            <input type="text" class="text" name="EditPrestationNomenclature"  id="EditPrestationNomenclature" size="10" maxlength="20" value="<%=checkString(prestation.getNomenclature())%>" onkeyup="getNomenclatureLabel();">
...
<script>
  ...
  function getNomenclatureLabel(){
      document.getElementById('nomenclatureText').innerHTML = "<img src='<%=sCONTEXTPATH%>/_img/themes/<%=sUserTheme%>/ajax-loader.gif'/><br/>Loading";
	    var today = new Date();
	    var code=transactionForm.EditPrestationNomenclature.value;
  ...
  function searchNomenclature(){
	  <%if(SH.cs("prestationNomenclatureTable","nups").equalsIgnoreCase("nups")){%>
	      openPopup("/_common/search/searchNUPS.jsp&PopupWidth=800&PopupHeight=500&ts=<%=getTs()%>&VarCode=EditPrestationNomenclature");
	  <%}%>
      transactionForm.EditPrestationNomenclature.focus();
  }
