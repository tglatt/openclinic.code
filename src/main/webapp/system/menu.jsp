        ...
        <tr>
            <td>
                <%
                    ...
                    hMenu.put(getTran(request,"web.manage","ManageBeacons",sWebLanguage),"main.do?Page=system/manageBeacons.jsp");
        ...
        <tr>
            <td>
                <% 
                    ...
                    hMenu.put(getTran(request,"web","analyzedhis2server",sWebLanguage),"main.do?Page=dhis2/analyzeDHIS2JSON.jsp");
        ...
        <tr>
            <td>
                <%
                    int idx = 0;
                    hMenu = new Hashtable();
	                hMenu.put(getTran(request,"web.manage","managenups",sWebLanguage),"main.do?Page=nups/manageNUPSCodes.jsp"); idx++;
