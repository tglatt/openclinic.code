...
<%!
    ...
    private String writeMyRow(String sID, String sWebLanguage, String sIcon){
        ...
        return "<tr><td>"
            +sIcon+"&nbsp;<img src='"+sCONTEXTPATH+"/_img/icons/icon_view.png' alt='"+getTranNoLink("Web","view",sWebLanguage)+"'"
                            ...
                            <%
                                if(sViewCode.length()>0 || iTotal==0){
                                    ...
                                    if(service!=null){
                                        ...
                                        out.print(setRow(request,"Web","zipcode", checkString(service.zipcode),sWebLanguage));
                                        out.print(setRow(request,"Web","city", checkString(service.city),sWebLanguage));
                                        out.print(setRow(request,"Web","country", sCountry,sWebLanguage));
                                        out.print(setRow(request,"Web","telephone", checkString(service.telephone),sWebLanguage));
                                        out.print(setRow(request,"Web","fax", checkString(service.fax),sWebLanguage));
                                        out.print(setRow(request,"Web","contract", checkString(service.contract),sWebLanguage));
                                        out.print(setRow(request,"Web","contracttype", checkString(service.contracttype),sWebLanguage));
                                        out.print(setRow(request,"Web","contactperson", checkString(service.contactperson),sWebLanguage));
                                        out.print(setRow(request,"Web","comment", checkString(service.comment),sWebLanguage));
                                        out.print(setRow(request,"Web","medicalcentre", checkString(service.code5),sWebLanguage));
