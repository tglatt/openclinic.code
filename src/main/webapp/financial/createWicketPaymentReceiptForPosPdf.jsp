...
<%@ page import="be.mxs.common.util.pdf.general.PDFWicketReceiptGeneratorForPos1" %>
...
<%
    ...
    try{
        // PDF generator
        WicketCredit credit = WicketCredit.get(sCreditUid);
        sProject = checkString((String)session.getAttribute("activeProjectTitle")).toLowerCase();
        PDFWicketReceiptGeneratorForPos1 pdfGenerator = new PDFWicketReceiptGeneratorForPos1(activeUser,credit,sProject,sPrintLanguage);
