...
<%
	...
	if(status.length()==0){
		...
		if(rs.next()){
		    ...
		    try {
		    	credit.setInvoiceUid(SH.getServerId()+"."+Integer.parseInt(request.getParameter("transactionId").split("\\.")[0]));
		    ...
		    credit.setComment("Moov transaction "+SH.p(request,"financialTransactionId"));
