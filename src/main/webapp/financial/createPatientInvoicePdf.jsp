...
<%
    ...
    try{
        ...
        else if(!sProforma.equalsIgnoreCase("debetnote") && sPrintModel.equalsIgnoreCase("prestationlist")){
        	pdfGenerator = new PDFPatientPrestationListGenerator(activeUser,invoice.getPatient(),sProject,sPrintLanguage,sProforma);
        }
        else {
