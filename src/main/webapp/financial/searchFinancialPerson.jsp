<%@page import="java.util.*,
                ...
                be.openclinic.finance.CreditTransaction"%>
...
<%
    ...
    /// DEBUG /////////////////////////////////////////////////////////////////////////////////////
    if(Debug.enabled){
        Debug.println("\n******************* financial/searchFinancialPerson.jsp ****************");
        Debug.println("sActiveBalanceID : "+sActiveBalanceID);
    ...
    Vector vPersonIDs  = DebetTransaction.getPersonSupplierDebetTransactionByID(sActiveBalanceID),
           vPersonIDs2 = CreditTransaction.getPersonSupplierCreditTransactionByID(sActiveBalanceID);
