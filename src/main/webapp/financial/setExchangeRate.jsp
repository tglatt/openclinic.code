...
<form name='transactionForm' method='post'>
	<table width='400px'>
		...
		<tr>
			<td class='admin'><%=getTran(request,"web","secondarycurrency",sWebLanguage) %></td>
			<td class='admin2'>
				<select class='text' name='ercurrency' onchange='checkrate();'>
					<%=ScreenHelper.writeSelectExclude(request, "currency", sCurrency, sWebLanguage, false, false, SH.cs("currency","").toLowerCase()) %>
				</select>
			</td>
		</tr>
		<tr>
