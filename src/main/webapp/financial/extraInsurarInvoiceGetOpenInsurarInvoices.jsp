...
<%
    ...
    Vector vOpenInsurarInvoices = ExtraInsurarInvoice.getInsurarInvoicesWhereDifferentStatus("'closed','canceled'");
    ...
    for (int i = 0; i < vOpenInsurarInvoices.size(); i++) {
        insurarInvoice = (ExtraInsurarInvoice) vOpenInsurarInvoices.elementAt(i);
