            ...
            while(groupKeysIter.hasNext()){
            	...
            	if(mostRecentDebet!=null){            	
	            	...
	            	sHtml+= "<tr class='list1' "+sOnClick+">"+
	                         ...
	                         "<td "+(oneGroup.size()>1?"":" style='cursor:pointer'")+">"+SH.getTotalPriceString((dbl((String)groupInfo.get("amount"))+dbl((String)groupInfo.get("insurarAmount"))+dbl((String)groupInfo.get("extraInsurarAmount"))))+"</td>"+
	                         "<td "+(oneGroup.size()>1?"":" style='cursor:pointer'")+" "+(checkString(mostRecentDebet.getExtraInsurarUid2()).length()>0?"style='text-decoration:line-through'":"")+">"+SH.getTotalPriceString(dbl((String)groupInfo.get("amount")))+"</td>"+
	                         "<td "+(oneGroup.size()>1?"":" style='cursor:pointer'")+">"+SH.getTotalPriceString(dbl((String)groupInfo.get("insurarAmount")))+"</td>"+
	                         "<td "+(oneGroup.size()>1?"":" style='cursor:pointer'")+">"+SH.getTotalPriceString(dbl((String)groupInfo.get("extraInsurarAmount")))+"</td>"+
                ...
                if(debet!=null){
	                ...
	                hSorted.put(sPatientName.toUpperCase()+"="+debet.getDate().getTime()+"="+debet.getUid()," onclick=\"setDebet('"+debet.getUid()+"','"+groupIdx+"');\">"
	                        ...
	                        +"<td style='padding-left:5px;'>"+HTMLEntities.htmlentities(sPrestationDescription)+" ("+debet.getQuantity()+"x)</td>"
  	                        +"<td style='padding-left:5px;'>"+HTMLEntities.htmlentities(sInsurer)+"</td>"
   	                        +"<td style='padding-left:5px;'>"+SH.getTotalPriceString((debet.getAmount()+debet.getInsurarAmount()+dExtraInsurarAmount))+"</td>"
	                        +"<td style='padding-left:5px;' "+(checkString(debet.getExtraInsurarUid2()).length()>0?"style='text-decoration:line-through'":"")+">"+SH.getTotalPriceString(debet.getAmount())+"</td>"
	                        +"<td style='padding-left:5px;'>"+SH.getTotalPriceString(debet.getInsurarAmount())+"</td>"
	                        +"<td style='padding-left:5px;'>"+SH.getTotalPriceString(dExtraInsurarAmount)+"</td>"
