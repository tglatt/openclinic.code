        ...
        <%
	    	if(sEditDebetUID.length() > 0 && debet!=null && debet.getPrestation()!=null){
	    		...
	    		out.print("<tr>"+
	    		           ...
	    		           "<td><span id='TPPP_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(debet.getAmount())+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+"</td>"+
	    		           "<td><span id='TPPI_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(debet.getInsurarAmount())+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+"<span id='TPPC_"+prestation.getUid()+"'>"+coveragePct+"</span>"+sNegociate+"</td>"+
	    		           "<td><span id='TPPE_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(debet.getExtraInsurarAmount())+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+sNegociate2+"</td>");
