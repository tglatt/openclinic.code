                    ...
                    <table class='list' border='0' width='100%' cellspacing='1'>
                        ...
                        <tr id="Service">
                            ...
                            <td class='admin2'>
                                ...
                                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditEncounterForm.EditEncounterService.value='';EditEncounterForm.EditEncounterServiceName.value='';">
                            </td>
                        </tr>
                        <%-- outcome --%>
                        <tr>
