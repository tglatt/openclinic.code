...
%>
	...
	<script>
		function printReport(){
			...
			window.open('<c:url value="pharmacy/printServiceStockInventorySummary.jsp"/>?outputformat='+document.getElementById('outputformat').value+'&ProductGroup='+document.getElementById('productgroup').value+'&ProductSubGroup='+document.getElementById('EditProductSubGroup').value+'&FindDate='+document.getElementById('FindDate').value+'&ServiceStockUid='+servicestocks);
			window.close();
		}
