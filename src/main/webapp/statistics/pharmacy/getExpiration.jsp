...
<script>
  function printReport(){
	window.open('<c:url value="pharmacy/printExpiration.jsp"/>?outputformat='+document.getElementById('outputformat').value+'&begin='+document.getElementById('begin').value+'&end='+document.getElementById('end').value+'&ServiceStockUid=<%=sServiceStockId%>');
	window.close();
  }
</script>