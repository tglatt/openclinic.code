...
<script>
  function printReport(){
	window.open('<c:url value="pharmacy/printServiceOutgoingStockOperationsListing.jsp"/>?outputformat='+document.getElementById('outputformat').value+'&FindBeginDate='+document.getElementById('FindBeginDate').value+'&FindEndDate='+document.getElementById('FindEndDate').value+'&ServiceStockUid=<%=sServiceStockId%>&userid='+document.getElementById('userid').value);
	window.close();
  }
</script>