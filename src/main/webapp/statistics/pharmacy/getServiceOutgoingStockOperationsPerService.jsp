...
<script>
  function printReport(){
	url='<c:url value="pharmacy/printServiceOutgoingStockOperationsPerService.jsp"/>?outputformat='+document.getElementById('outputformat').value+'&FindBeginDate='+document.getElementById('FindBeginDate').value+'&FindEndDate='+document.getElementById('FindEndDate').value;
