...
<form name="drugsOutForm" method="post">
	<input type='hidden' name='invoiceuid' id='invoiceuid'/>
...
<script>
	...
	function registerMomoPayment(cashdesk,comment,financialTransactionId){
		document.getElementById("EditCreditWicketUid").value=cashdesk;
		quickReceipt(comment,financialTransactionId);
	}
  ...
  function quickReceipt(comment,financialTransactionId){
	var params ="wicketuid="+document.getElementById('EditCreditWicketUid').value+
    ...
    var url = '<c:url value="/pharmacy/quickInvoiceDrugsOutBarcode.jsp"/>';
    new Ajax.Request(url,{
        method: "GET",
        parameters: params,
        onSuccess: function(resp){
