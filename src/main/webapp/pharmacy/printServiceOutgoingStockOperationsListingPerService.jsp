...
<%
	...
	String sDestinationServiceStockId=checkString(request.getParameter("DestinationStockUid"));
    ...
    try {
        ...
        parameters.put("destinationStockUID",sDestinationServiceStockId);
        parameters.put("begin",sBeginDate);
        parameters.put("end",sEndDate);
    	baosPDF = pdfGenerator.generatePDFDocumentBytes(request,"serviceOutgoingStockOperationsListingPerService",parameters);
