	...
	<%
		...
		while(i.hasNext()){
			...
			<tr>
				...
				<td class='admin2' valign='top'><%=SH.ci("translateInteractions",0)==0?code.split(";")[1]:GoogleTranslate.translate(MedwanQuery.getInstance().getConfigString("googleTranslateKey","-"),"en", sWebLanguage,code.split(";")[1]) %></td>
			</tr>
