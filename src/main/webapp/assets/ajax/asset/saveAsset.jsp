...
<%
 ...
 if(asset.countSerialNumber(asset.getObjectId(),
    		asset.getSerialnumber())){
    	 sMessage = "<font color='red'>"+getTranNoLink("web","error.existing.serialnumber",sWebLanguage)+"</font>";
    	 sStatus = "error.serialnumber";
 }else{
