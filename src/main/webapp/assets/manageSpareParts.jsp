...
<%
	...
	if(SH.p(request,"deleteButton").length()>0){
			...
			<table width='100%'>
				...
				<tr>
					...
					<td>
						...
						<% } %>
						<% if(sAction.equalsIgnoreCase("edit") && activeUser.getAccessRight("spareparts.delete")){%>
							<input type='submit' class='button' name='deleteButton' id='deleteButton' value='<%=getTranNoLink("web","delete",sWebLanguage) %>'/>
						<% } %>
					</td>
				</tr>
			</table>
