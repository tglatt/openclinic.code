...
<%
    ...
    String sAssetUID = SH.c((String)hParameters.get("assetuid"));
    String sDocumentName = SH.c((String)hParameters.get("name"));
    String sUrl = (String)hParameters.get("url");
    String sMaintenancePlanUid = SH.c((String)hParameters.get("maintenanceplanuid"));
    SH.syslog("sMaintenancePlanUid="+sMaintenancePlanUid);
    SH.syslog("sDocumentName="+sDocumentName);
    FormFile formFile = (FormFile)hParameters.get("filename");
    if(formFile!=null){
        try{
            if(formFile!=null){
        	    String sFileName = formFile.getFilename();
        	    SH.syslog("sFileName="+sFileName);
        	    SH.syslog("sMaintenancePlanUid.length()="+sMaintenancePlanUid.length());
