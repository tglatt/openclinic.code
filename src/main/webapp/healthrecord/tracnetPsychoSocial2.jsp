	...
	<tr>
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.enfants",sWebLanguage)%>	
					</td>
				</tr>
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth %>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.composition.famille",sWebLanguage)%>
					</td>
					<td class="admin2">
						<table>
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.type",sWebLanguage)%></td>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.nombre",sWebLanguage)%></td>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.nombre.charge",sWebLanguage)%></td>
							</tr>
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.enfants.moins.six",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.enfants.plus.six.scolarisés",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.enfants.plus.six.non.scolarisés",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.adultes",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.total",sWebLanguage)%></td>
								<td>
				...
				<tr id="planning_familial2" style="display:none;">		
					...
					<td class="admin2">
						<select id="planning_familial_frequence" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_FREQUENCE_PLANNING" property="itemId"/>]>.value">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.fréquence.planning",sType,sWebLanguage,false,true)%>
		                </select>
					</td>
				</tr>
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth %>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.décisions.familiale",sWebLanguage)%>
					</td>
					<td class="admin2">
		...
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.info.socio.eco",sWebLanguage)%>	
					</td>
				</tr>
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth %>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.niveau.instruction",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth %>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.profession",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth %>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.revenu.ménage",sWebLanguage)%>
					</td>
					<td class="admin2">
						<table>
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.patient",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.conjoint",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.autre.personne",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><b><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.total",sWebLanguage)%></b></td>
								<td>
