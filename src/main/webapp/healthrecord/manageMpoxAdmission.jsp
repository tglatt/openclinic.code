...
<!-- 
 ...
 -->
<%
	String accessright="mpox.admission";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDATE1", sWebLanguage, sCONTEXTPATH,"onkeyup='checkcontact(1)' onmouseup='checkcontact(1)' onfocus='checkcontact(1)'") %>
        	</td>
        	<td class='admin2'>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTTYPE1", "mpox.contacttypenew", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","link",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTLINK1", "mpox.contactlink", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","name",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTNAME1", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","telephone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPHONE1", 20) %>
        	</td>
        </tr>
        <tr>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPROVINCE1", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","district",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDISTRICT1", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","zone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTZONE1", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","town",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTTOWN1", 20) %>
        	</td>
        </tr>
        <tr id='contact2' style='display:none'>
        	...
        	<td class='admin4'>
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDATE2", sWebLanguage, sCONTEXTPATH,"onkeyup='checkcontact(2)' onmouseup='checkcontact(2)' onfocus='checkcontact(2)'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","type",sWebLanguage) %>: <img src='<%=sCONTEXTPATH %>/_img/icons/icon_info.gif' onclick="zoomlarge('<%=sCONTEXTPATH %>/_img/sormas/mpoxtype-<%=sWebLanguage %>.png')" onmouseover='this.style.cursor="hand"' title='<%=getTranNoLink("web","info",sWebLanguage) %>' style='vertical-align: middle'/>
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTTYPE2", "mpox.contacttypenew", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","link",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTLINK2", "mpox.contactlink", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","name",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTNAME2", 30) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","telephone",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPHONE2", 20) %>
        	</td>
        </tr>
        <tr id='contact2b' style='display:none'>
        	...
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPROVINCE2", 20) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","district",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDISTRICT2", 20) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","zone",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTZONE2", 30) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","town",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTTOWN2", 20) %>
        	</td>
        </tr>
        <tr id='contact3' style='display:none'>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDATE3", sWebLanguage, sCONTEXTPATH,"onkeyup='checkcontact(3)' onmouseup='checkcontact(3)' onfocus='checkcontact(3)'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","type",sWebLanguage) %>: <img src='<%=sCONTEXTPATH %>/_img/icons/icon_info.gif' onclick="zoomlarge('<%=sCONTEXTPATH %>/_img/sormas/mpoxtype-<%=sWebLanguage %>.png')" onmouseover='this.style.cursor="hand"' title='<%=getTranNoLink("web","info",sWebLanguage) %>' style='vertical-align: middle'/>
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTTYPE3", "mpox.contacttypenew", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","link",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTLINK3", "mpox.contactlink", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","name",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTNAME3", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","telephone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPHONE3", 20) %>
        	</td>
        </tr>
        <tr id='contact3b' style='display:none'>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPROVINCE3", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","district",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDISTRICT3", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","zone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTZONE3", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","town",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTTOWN3", 20) %>
        	</td>
        </tr>
        <tr id='contact4' style='display:none'>
        	...
        	<td class='admin4'>
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDATE4", sWebLanguage, sCONTEXTPATH,"onkeyup='checkcontact(4)' onmouseup='checkcontact(4)' onfocus='checkcontact(4)'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","type",sWebLanguage) %>: <img src='<%=sCONTEXTPATH %>/_img/icons/icon_info.gif' onclick="zoomlarge('<%=sCONTEXTPATH %>/_img/sormas/mpoxtype-<%=sWebLanguage %>.png')" onmouseover='this.style.cursor="hand"' title='<%=getTranNoLink("web","info",sWebLanguage) %>' style='vertical-align: middle'/>
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTTYPE4", "mpox.contacttypenew", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","link",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTLINK4", "mpox.contactlink", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","name",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTNAME4", 30) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","telephone",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPHONE4", 20) %>
        	</td>
        </tr>
        <tr id='contact4b' style='display:none'>
        	...
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPROVINCE4", 20) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","district",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDISTRICT4", 20) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","zone",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTZONE4", 30) %>
        	</td>
        	<td class='admin4'>
        		<%=getTran(request,"web","town",sWebLanguage) %>:
        	</td>
        	<td class='admin4'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTTOWN4", 20) %>
        	</td>
        </tr>
        <tr id='contact5' style='display:none'>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDATE5", sWebLanguage, sCONTEXTPATH) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","type",sWebLanguage) %>: <img src='<%=sCONTEXTPATH %>/_img/icons/icon_info.gif' onclick="zoomlarge('<%=sCONTEXTPATH %>/_img/sormas/mpoxtype-<%=sWebLanguage %>.png')" onmouseover='this.style.cursor="hand"' title='<%=getTranNoLink("web","info",sWebLanguage) %>' style='vertical-align: middle'/>
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTTYPE5", "mpox.contacttypenew", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","link",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastSelect(request, tran, "ITEM_TYPE_MPOX_CONTACTLINK5", "mpox.contactlink", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","name",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTNAME5", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","telephone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPHONE5", 20) %>
        	</td>
        </tr>
        <tr id='contact5b' style='display:none'>
        	...
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTPROVINCE5", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","district",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTDISTRICT5", 20) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","zone",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTZONE5", 30) %>
        	</td>
        	<td class='admin2'>
        		<%=getTran(request,"web","town",sWebLanguage) %>:
        	</td>
        	<td class='admin2'>
        		<%=SH.writeDefaultLastTextInput(request, tran, "ITEM_TYPE_MPOX_CONTACTTOWN5", 20) %>
        	</td>
        </tr>
    </table>
    <table width='100%'>
        ...
        <tr class='admin'>
        	<td colspan='8'><%=getTran(request,"web","lastyearhistory",sWebLanguage) %></td>
        </tr>
        <tr>
			<td class='admin2topright'><%=getTran(request,"web","chlamydia",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_CHLAMYDIA", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","gonorrhea",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_GONORRHEA", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","genitalherpes",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_GENITALHERPES", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","lymphogranuloma",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_LYMPHOGRANULOMA", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
       </tr>
       <tr>
			<td class='admin2topright'><%=getTran(request,"web","mycoplasmagenitalium",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_MYCOPLASMAGENITALIUM", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","syphilis",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_SYPHILIS", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","trichomona",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_TRICHOMONA", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
			<td class='admin2topright'><%=getTran(request,"web","genitalwarts",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_GENITALWARTS", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
       </tr>
       <tr>
			<td class='admin2topright'><%=getTran(request,"web","otherist",sWebLanguage) %></td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_OTHERIST", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
        	<%
        		if(SH.c(activePatient.gender).equalsIgnoreCase("f")){
        	%>
					<td class='admin2topright'><%=getTran(request,"web","pregnancy",sWebLanguage) %></td>
		        	<td class='admin2top'>
		        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_PREGNANCY", "mpox.pregnancy", sWebLanguage, "onchange='triage()'") %>
		        	</td>
		    <%
        		}
        		else {
		    ...
		    %>
			<td class='admin2topright'><%=getTran(request,"web","immunosuppression",sWebLanguage) %></td>
        	<td class='admin2top' colspan='3'>
        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_IMMUNOSUPPRESSION", "mpox.immunosuppression", sWebLanguage, "onchange='triage()'") %>
        	</td>
       </tr>
        <tr class='admin'>
		...
		<tr>
			...
			<td class='admin2' colspan='6'><% writeVitalSignsToday(pageContext); %></td>
		</tr>
        <tr class='admin'>
        ...
        <tr>
        	<td class='admin' colspan='2'>
        		<%=getTran(request,"web","begin",sWebLanguage) %>:
        		<%=SH.writeDefaultLastDateInput(request, tran, "ITEM_TYPE_MPOX_RASHONSET", sWebLanguage, sCONTEXTPATH, "onchange='triage();' onfocus='triage();'") %>
        	</td>
        	<td class='admin'><%=getTran(request,"web","bodyparts",sWebLanguage) %></td>
        	<td class='admin2' colspan='5'>
        		<%=SH.writeDefaultLastCheckBoxes(tran, request, "mpox.rashlocations" , "ITEM_TYPE_MPOX_RASHLOCATIONS", sWebLanguage, false) %>
        	</td>
        </tr>
        <tr>
        	<td class='admin' colspan='2'>
        	...
        	<td class='admin2top' id='macula'>
        		<%=SH.writeDefaultLastCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_MACULA", sWebLanguage, "onchange='triage();'") %>
        	...
        	<td class='admin2top' id='papula'>
        		<%=SH.writeDefaultLastCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_PAPULA", sWebLanguage, "onchange='triage();'") %>
        	...
        	<td class='admin2top' id='vesicula'>
        		<%=SH.writeDefaultLastCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_VESICULA", sWebLanguage, "onchange='triage();'") %>
        	...
        	<td class='admin2top' id='pustula'>
        		<%=SH.writeDefaultLastCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_PUSTULA", sWebLanguage, "onchange='triage();'") %>
        	...
        	<td class='admin2top' id='scab'>
        		<%=SH.writeDefaultLastCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_SCAB", sWebLanguage, "onchange='triage();'") %>
        ...
        <tr class='admin'>
        	<td colspan='8'><%=getTran(request,"web","lab",sWebLanguage) %></td>
        </tr>
        <tr>
        	<td colspan='2'>
        		<table width='100%'>
        			<tr>
			        	<td class='admin' title='Antigen test'><%=getTran(request,"web","rapidtest",sWebLanguage) %></td>
			        	<td class='admin2'>
			        		<%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_MPOX_RAPIDTEST", sWebLanguage, false, "onchange='triage()'", "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin' title='Loop-mediated amplification'>LAMP</td>
			        	<td class='admin2'>
			        		<%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_MPOX_LAMP", sWebLanguage, false, "onchange='triage()'", "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin' title='Polymerase Chain Reaction'>PCR</td>
			        	<td class='admin2'>
			        		<%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_MPOX_PCR", sWebLanguage, false, "onchange='triage()'", "") %>
			        	</td>
			        </tr>
			        </tr>
			        <tr>
			        	<td class='admin'>GeneXpert</td>
			        	<td class='admin2'>
			        		<%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_MPOX_GENEXPERT", sWebLanguage, false, "onchange='triage()'", "") %>
			        	</td>
			        </tr>
			    </table>
			</td>
			<td class='admin'><%=getTran(request,"web","classification",sWebLanguage) %></td>
			<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_CLASSIFICATION", "mpox.classification", sWebLanguage, "onchange='triage()'") %></td>
        	<td class='admin2' colspan='4'>
        		<span id='differentialdiagnosis'></span>
        	</td>
        </tr>
        <%-- PRE-EXISTING CONDITIONS --%>
        <tr class="admin">
            <td colspan="8"><%=getTran(request,"mpox","comorbidity",sWebLanguage)%>&nbsp;</td>
        </tr>
        <tr>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_TUBERCULOSIS", "yesnounknown", sWebLanguage, "onchange='triage(this);'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","asplenia",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_ASPLENIA", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","hepatitis",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_HEPATITIS", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","diabetes",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_DIABETES", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin2topright'>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_IMMUNODEFICIENCYNONHIV", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","congenitalsyphilis",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_SYPHILIS2", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","down",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_DOWN", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","liverdisease",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_LIVERDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin2topright'>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_MALIGNANCY", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","chronicheartfailure",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_CHRONICHEARTFAILURE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","chroniclungdisease",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_CHRONICLUNGDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","renaldisease",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_RENALDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin2topright'>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_NEUROLOGICDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","hypertension",sWebLanguage) %>
        	</td>
        	<td class='admin2top' colspan='5'>
        		<%=SH.writeDefaultLastToggle(request, tran, "ITEM_TYPE_MPOX_HYPERTENSION", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","hiv",sWebLanguage) %></td>
        	<td class='admin2'>
        		<%=SH.writeDefaultCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_HIV_PREP", sWebLanguage, "onchange='triage()'") %>
        		<%=getTran(request,"web","prep",sWebLanguage) %>
        	</td>
        	<td class='admin'><%=getTran(request,"web","serologystatus",sWebLanguage) %></td>
        	<td class='admin2' colspan='2'>
        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_HIV_SEROLOGY","posnegunknown",sWebLanguage,"onchange='triage()'") %>
        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_HIV_SEROLOGY_EVALUATION","mpox.serologyevaluation",sWebLanguage,"onchange='triage()'") %>
        	</td>
        	<td class='admin2' colspan='3'>
        		<span id='vihpositive' style='display: none'>
	        		<%=getTran(request,"web","viralload",sWebLanguage) %>:
	        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_HIV_VIRALLOAD", "mpox.viralload", sWebLanguage, "onchange='triage()'") %>
	        		&nbsp;&nbsp;<%=getTran(request,"web","cd4",sWebLanguage) %>:
	        		<%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_MPOX_HIV_CD4", 5, 0, 999999, sWebLanguage) %> c/mm3
	        		&nbsp;&nbsp;<%=SH.writeDefaultCheckBox(tran, request, "yesno", "ITEM_TYPE_MPOX_HIV_ART", sWebLanguage, "onchange='triage()'") %>
	        		<%=getTran(request,"web","underart",sWebLanguage) %>
	        	</span>
        	</td>
        </tr>
        <tr class="admin">
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"mpox","treament",sWebLanguage) %></td>
        	<td class='admin2' colspan='7'>
        		<%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MPOX_TREAMENT", 100, 1) %>
        	</td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"msas","comment",sWebLanguage) %></td>
        	<td class='admin2' colspan='7'>
        		<%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MPOX_COMMENT", 100, 1) %>
        	</td>
        </tr>
        <tr class="admin">
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"mpox","oldsmallpoxvaccination",sWebLanguage) %></td>
        	<td class='admin2'>
        		<%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MPOX_SMALLPOXVACCINE", "yesnounknown", sWebLanguage, "onchange='triage()'") %>
        	</td>
        	<td class='admin'><%=getTran(request,"mpox","oldsmallpoxvaccinationdate",sWebLanguage) %></td>
        	<td class='admin2' nowrap>
        		<%=SH.writeDefaultDateInput(session, tran, "ITEM_TYPE_MPOX_SMALLPOXVACCINEDATE", sWebLanguage, sCONTEXTPATH) %>
        	</td>
        ...
        <tr>
        	...
        	<td class='admin2' colspan='6'>
        		<%=SH.writeDefaultRadioButtons(tran, request, "mpox.decisionnew2", "ITEM_TYPE_MPOX_DECISION", sWebLanguage, false, "onchange='triage()'", "") %>
        ...
        <tr>
        	...
        	<td class='admin2' colspan='4'>
        		<%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MPOX_INSTRUCTIONS", 60, 1) %>
        	</td>
    ...
    <table width="100%" class="list" cellspacing="1">
        ...
        <tr class="admin">
            <td align="center"><%=getTran(request,"curative","medication.paperprescriptions",sWebLanguage)%> (<%=ScreenHelper.stdDateFormat.format((tran).getUpdateTime())%>)</td>
        </tr>
        <%
            Vector paperprescriptions = PaperPrescription.find(activePatient.personid,"",ScreenHelper.stdDateFormat.format((tran).getUpdateTime()),ScreenHelper.stdDateFormat.format((tran).getUpdateTime()),"","DESC");
...
<script>  
  ...
  if( document.getElementById('encounteruid').value=="" <%=(tran).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_REFERRAL_SOURCESITE").length()==0 && request.getParameter("nobuttons")==null?"":" && 1==0"%>){
  ...
  function triage(){
	  if(document.getElementById("ITEM_TYPE_MPOX_DECISION").value=='4;'){
	  ...
	  if(document.getElementById("ITEM_TYPE_MPOX_HIV_SEROLOGY").value=='1'){
		  document.getElementById("vihpositive").style.display='';
	  }
	  else{
		  document.getElementById("vihpositive").style.display='none';
	  }
