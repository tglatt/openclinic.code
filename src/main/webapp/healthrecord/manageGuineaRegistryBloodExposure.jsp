...
<!-- 
 ...
 -->
<%
	String accessright="mshp.bloodexposure";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
            ...
            <td class='admin2'>
				<%=SH.writeDefaultSelect(request, tran, "!ITEM_TYPE_SERVICE", SH.cs("exposure.service.type","exposure.service"), sWebLanguage, "") %>
            </td>
        </tr>
        <tr>
			<td class='admin'><%=getTran(request,"web","hiv",sWebLanguage) %></td>
			<td class='admin2'><%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_HIV", sWebLanguage, false, "", "")%></td>
			<td class='admin'><%=getTran(request,"web","hepatitisb",sWebLanguage) %></td>
			<td class='admin2'><%=SH.writeDefaultRadioButtons(tran, request, "posneg", "ITEM_TYPE_HB", sWebLanguage, false, "", "")%></td>
        </tr>
