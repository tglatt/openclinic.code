            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						...
						<td width='20%'><%=getTran(request,"web","urine",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_URINE","mspls.labresult", sWebLanguage, "") %><%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_URINETEXT", 10) %>  </td>
						<td width='20%'><%=getTran(request,"web","hemoglobine",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HB","mspls.labresult", sWebLanguage, "") %> <%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_HBTEXT",5,1,50,sWebLanguage) %>g/dl   </td>
						<td width='20%'><%=getTran(request,"web","thiksmear",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_THIKSMEAR","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","thiksmear",sWebLanguage) %>  </td>
						<td><br/><%=getTran(request,"web","rapidtest",sWebLanguage) %><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_RAPIDTEST","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","rapidtest",sWebLanguage) %> </td>
					</tr>
					<tr>
						<td width='20%'><%=getTran(request,"web","bk",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_BK","mspls.labresult", sWebLanguage, "") %><%=getTran(request,"web","bk",sWebLanguage) %>  </td>
						<td width='20%'><%=getTran(request,"web","pregnancy",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_PREGNANCY","mspls.labresult", sWebLanguage, "") %><%=getTran(request,"web","pregnancy",sWebLanguage) %>  </td>
						<td width='20%'><%=getTran(request,"web","hiv",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HIV","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","hiv",sWebLanguage) %> </td>
						<td width='20%'><%=getTran(request,"web","glycemia",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_GLYCEMIA","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","glycemia",sWebLanguage) %>  </td>
