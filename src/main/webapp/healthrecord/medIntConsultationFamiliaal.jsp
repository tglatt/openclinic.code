...
<%!
    ...
    private String addKinderen(int iTotal, String sTmpKinderenGeboortejaar, String sTmpKinderenGeslacht, String sTmpKinderenFirstname, String sWebLanguage) {
        ...
        sOut.append("<tr id='rowKinderen"+iTotal+"'>")
             .append("<td width='36'>")
              .append("<a href='javascript:deleteKinderen(rowKinderen"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup", "medwan.common.delete", sWebLanguage)+"' border='0'></a> ")
              .append("<a href='javascript:editKinderen(rowKinderen"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup", "medwan.common.edit", sWebLanguage)+"' border='0'></a>")
             .append("</td>");
    ...
    private String addFami(int iTotal, String sTmpFamiDate, String sTmpFamiDescr, String sTmpFamiVerwantschap, String sWebLanguage) {
        return "<tr id='rowFami"+iTotal+"'>"
               +"<td width='36'>"
                +"<a href='javascript:deleteFami(rowFami"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup", "medwan.common.delete", sWebLanguage)+"' border='0'></a> "
                +"<a href='javascript:editFami(rowFami"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup", "medwan.common.edit", sWebLanguage)+"' border='0'></a>"
               +"</td>"
               +"<td>&nbsp;"+sTmpFamiDate+"</td>"
               +"<td>&nbsp;"+sTmpFamiDescr+"</td>"
...
function addKinderen(){
  if(isAtLeastOneKinderenFieldFilled()){
    ...
    if(birthDate.getTime() > today.getTime()){
      ...
      td.innerHTML = "<a href='javascript:deleteKinderen(rowKinderen"+iIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editKinderen(rowKinderen"+iIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateKinderen(){
  if(isAtLeastOneKinderenFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteKinderen("+editKinderenRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editKinderen("+editKinderenRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addFami(){
  if(isAtLeastOneFamiFieldFilled()){
    ...
    var td = tr.insertCell(0);
    td.innerHTML = "<a href='javascript:deleteFami(rowFami"+iIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                  +"<a href='javascript:editFami(rowFami"+iIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a> ";
    tr.appendChild(td);
...
function updateFami(){
  if(isAtLeastOneFamiFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteFami("+editFamiRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editFami("+editFamiRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
