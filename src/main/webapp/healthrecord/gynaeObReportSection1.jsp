...
<table cellspacing="1" cellpadding="0" width="100%" border="0" id="fetalDescription" class="list">
   ...
   <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_FETAL_HEAD" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_HEAD")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_HEAD" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_HEAD%>" >
   ...
   <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_PLACENTA_LOCATION" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_PLACENTA_LOCATION")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_PLACENTA_LOCATION" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_PLACENTA_LOCATION%>" >
   ...
   <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_PLACENTA_GRADE" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_PLACENTA_GRADE")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_PLACENTA_GRADE" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_PLACENTA_GRADE%>" onblur="isNumber(this);">
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_3V_CORD" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_3V_CORD")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_3V_CORD" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_3V_CORD%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_AMNIOTIC_FLUID" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_AMNIOTIC_FLUID")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_AMNIOTIC_FLUID" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_AMNIOTIC_FLUID%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_FACE" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FACE")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FACE" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FACE%>" >
   ...
   <%-- fetal BRAIN ----------------------------------------------------------------------%>
    ...
    <tr>
        ...
        <td class="admin2">
            <input id="ac_ITEM_TYPE_OBREPORT_LATERAL_VENTRICLES" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_LATERAL_VENTRICLES")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_LATERAL_VENTRICLES" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_LATERAL_VENTRICLES%>" >
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_CEREBELLUM" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_CEREBELLUM")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_CEREBELLUM" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_CEREBELLUM%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_CIST_MAGNA" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_CIST_MAGNA")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_CIST_MAGNA" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_CIST_MAGNA%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_ABDOMINAL_WALL" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_ABDOMINAL_WALL")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_ABDOMINAL_WALL" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_ABDOMINAL_WALL%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_RIGHT_KIDNEY" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_RIGHT_KIDNEY")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_RIGHT_KIDNEY" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_RIGHT_KIDNEY%>" >
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_UPPER_EXTREMITIES" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_UPPER_EXTREMITIES")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_UPPER_EXTREMITIES" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_UPPER_EXTREMITIES%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <textarea id="ac_ITEM_TYPE_OBREPORT_COMMENTAIRE" cols="50" rows="2" onKeyup="resizeTextarea(this,10);" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_COMMENTAIRE")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_COMMENTAIRE" property="itemId"/>]>.value"><%=sITEM_TYPE_OBREPORT_COMMENTAIRE%></textarea>
   ...
   <tr>
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_UTERUS" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_UTERUS")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_UTERUS" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_UTERUS%>">
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_KIDNEYS" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_KIDNEYS")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_KIDNEYS" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_KIDNEYS%>">
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_RIGHT_OVARY" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_RIGHT_OVARY")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_RIGHT_OVARY" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_RIGHT_OVARY%>" >
    ...
    <tr>
        ...
        <td class="admin2">
             <input id="ac_ITEM_TYPE_OBREPORT_ADNEXA" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_ADNEXA")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_ADNEXA" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_ADNEXA%>" >
