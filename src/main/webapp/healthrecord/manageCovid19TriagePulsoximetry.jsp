            ...
            <td class="admin2" colspan="7">
            	<table width="100%">
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_FEVERPAST14DAYS", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","cough",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_COUGH", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","shortnessofbreath",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DYSPNEA", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_OBSTRUCTEDBREATHING", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","severepulmonarycomplaints",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SEVEREPULMONARYCOMPLAINTS", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","centralsyanosis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CENTRALCYANOSIS", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","shock",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SHOCK", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_COMA", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","convulsions",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' colspan='5'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CONVULSIONS", "yesno", sWebLanguage, "onclick='pretriage()'") %>
			        	</td>
			        </tr>
            	</table>
            </td>
        	...
        	<td colspan='8'>
        		<table width='100%'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_OLDAGE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","positivetest",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_TESTPOSITIVE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_TUBERCULOSIS", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","asplenia",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ASPLENIA", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hepatitis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEPATITIS", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","diabetes",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DIABETES", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_IMMUNODEFICIENCYNONHIV", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hiv",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HIV", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","congenitalsyphilis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SYPHILIS", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","down",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DOWN", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIVERDISEASE", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","malignancy",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_MALIGNANCY", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","chronicheartfailure",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICHEARTFAILURE", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","chroniclungdisease",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICLUNGDISEASE", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RENALDISEASE", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","neurologicdisease",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NEUROLOGICDISEASE", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hypertension",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' colspan='3'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HYPERTENSION", "yesnounknown", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SIGNSDURINGASSESSMENT", "yesno", sWebLanguage, "onclick='triage();'") %>
			        	</td>
			        </tr>
        		</table>
        	</td>
