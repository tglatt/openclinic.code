...
<!-- 
 ...
 -->
<%
	String accessright="mshp.dentist";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
		...
		<tr>
			...
			<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_TYPEOFCONSULTATION", "guinea.typeofconsultation2", sWebLanguage, "onchange='checkReference()'") %></td>
        ...
        <tr>
			<td class='admin'><%=getTran(request,"web","treatmentactions",sWebLanguage) %></td>
			<td class='admin2' colspan='3'><%=SH.writeDefaultCheckBoxes(tran, request, "gn.dentisttreatment", "ITEM_TYPE_DENTISTTREATMENT", sWebLanguage, false) %></td>
        </tr>
    </table>
...
<script>  
  function checkReference(){
	  if(document.getElementById('ITEM_TYPE_TYPEOFCONSULTATION').value==2 || document.getElementById('ITEM_TYPE_TYPEOFCONSULTATION').value==3){
