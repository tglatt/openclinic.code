			...
			<table width='100%' cellspacing='0' cellpadding='0'>
				...
				<tr style="vertical-align:top;padding:0px;">
					<td  colspan='2'>
						...
						<img id='img_ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY_MUSCTESTING_UPPERRIGHT' onload='this.onplay()' onplay='showDivValues("ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY_MUSCTESTING_UPPERRIGHT","musscle.upperright")' src='<%=sCONTEXTPATH %>/_img/icons/icon_plus.png' onclick='addDivValue("ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY_MUSCTESTING_UPPERRIGHT","musscle.upperright","musscle.upperright.value")'/>
