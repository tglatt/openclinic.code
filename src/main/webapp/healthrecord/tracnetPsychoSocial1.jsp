	...
	<tr>
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.déménagé",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select class="text" id="demenage" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DEMENAGE" property="itemId"/>]>.value" onchange="checkPage1Settings();">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.déménagé.fois",sType,sWebLanguage,false,true)%>
		                </select>
		                <div id="demenage_block" style="display:none;">
							<br/>
							<br/>
							<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.déménagé.suivi",sWebLanguage)%>
							<br/>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.statut.social",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select class="text" id="statut_social" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STATUT_SOCIAL" property="itemId"/>]>.value" onchange="checkPage1Settings();">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.statut",sType,sWebLanguage,false,true)%>
		                </select>
					</td>
				</tr>
			</table>
		...
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin" width="<%=sTDAdminWidth%>">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.info.couple.risques",sWebLanguage)%>	
					</td>
				</tr>
				<tr id="statut_social_block1" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.conjoint.name",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="statut_social_block2" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.conjoint.age",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="statut_social_block4" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.sérologique",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="statut_social_block6" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.prise.charge.ou",sWebLanguage)%>
					</td>
					<td class="admin2">
						...
						<div id="prise_charge_ou_block" style="display:none;">
							<br/>
							<br/>
	                        <%=getTran(request,"openclinic.chuk","tracnet.psychosocial.prise.charge.ou.suivi",sWebLanguage)%>
	                        <br/>
				...
				<tr id="statut_social_block7" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.incompréhensions.conjoint",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="statut_social_block9" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.usage.condoms.conjoint",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select class="text" id="usage_condoms_conjoint" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_USAGE_CONDOMS_CONJOINT" property="itemId"/>]>.value" onchange="checkPage1Settings();">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.usage.condoms",sType,sWebLanguage,false,true)%>
		                </select>
		                <div id="usage_condoms_conjoint_block" style="display:none;">
			                <br/>
			                <br/>
	                        <%=getTran(request,"openclinic.chuk","tracnet.psychosocial.usage.condoms.conjoint.suivi",sWebLanguage)%>
	                        <br/>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.partenaires.occasionnels.condoms",sWebLanguage)%>
					</td>
					<td class="admin2">
		                ...
		                <div id="partenaires_occasionnels_condoms_block" style="display:none;">
			                <br/>
			                <br/>
	                        <%=getTran(request,"openclinic.chuk","tracnet.psychosocial.partenaires.occasionnels.condoms.suivi",sWebLanguage)%>
	                        <br/>
