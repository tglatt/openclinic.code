        ...
        <tr>
        	<td width="50%" valign='top'>
	        	<table width='100%'>
		        	...
		        	<tr>
			            <td class='admin'><%=getTran(request,"web","audit",sWebLanguage)%>&nbsp;</td>
			            <td class='admin2'>
			            	<%=SH.writeDefaultRadioButtons(tran, request, "yesno", "ITEM_TYPE_MSAS_DECEASED_AUDIT", sWebLanguage, false, "", "") %>
			            </td>
			            <td class="admin"><%=getTran(request,"web","neonataldeath",sWebLanguage)%>&nbsp;</td>
			            <td class="admin2">
			            	<%=SH.writeDefaultRadioButtons(tran, request, "yesno", "ITEM_TYPE_MSAS_DECEASED_NEONATALDEATH", sWebLanguage, false, "", "") %>
			            </td>
			        </tr>
		        	<tr>
