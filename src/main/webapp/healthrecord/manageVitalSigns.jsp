    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
			...
			<td class='admin2'>
				<table width='100%' cellpadding="0" cellspacing="0">
					<tr>
						<td class='admin' width='12%'><%=getTran(request,"web", "urine", sWebLanguage)%><%=ScreenHelper.writeDefaultHiddenInput((TransactionVO)transaction, "ITEM_TYPE_BILAN") %></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_URINE", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td class='admin' width='12%'><%=getTran(request,"web", "vom", sWebLanguage)%></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_VOMITING", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td class='admin' width='12%'><%=getTran(request,"web", "diarrhea", sWebLanguage)%></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_DIARRHEA", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td class='admin' width='12%'><%=getTran(request,"web", "other", sWebLanguage)%></td>
						<td class='admin2' width='*'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_OUTPUT_OTHER", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			...
			<td class='admin2'>
				<table width='100%' cellpadding="0" cellspacing="0">
					<tr>
						<td class='admin' width='12%'><%=getTran(request,"web", "perf", sWebLanguage)%></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_PERFUSION", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td class='admin' width='12%'><%=getTran(request,"web", "drinks", sWebLanguage)%></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_DRINKS", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td class='admin' width='12%'><%=getTran(request,"web", "other", sWebLanguage)%></td>
						<td class='admin2' width='12%'><%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_HPRC_INPUT_OTHER", 3,0,5000,sWebLanguage,"calculatebilan()") %>ml</td>
						<td style='text-align: right' width='12%'><font color='red'><b><%=getTran(request,"web", "bilan", sWebLanguage)%> = </b></font></td>
...
<script>
	function calculatebilan(){
		var result=((document.getElementById('ITEM_TYPE_HPRC_INPUT_DRINKS').value*1)+(document.getElementById('ITEM_TYPE_HPRC_INPUT_PERFUSION').value*1)+(document.getElementById('ITEM_TYPE_HPRC_INPUT_OTHER').value*1)-(document.getElementById('ITEM_TYPE_HPRC_INPUT_URINE').value*1)-(document.getElementById('ITEM_TYPE_HPRC_INPUT_VOMITING').value*1)-(document.getElementById('ITEM_TYPE_HPRC_INPUT_DIARRHEA').value*1)-(document.getElementById('ITEM_TYPE_HPRC_OUTPUT_OTHER').value*1));
		if(result>0){
			result="+"+result;
		}
