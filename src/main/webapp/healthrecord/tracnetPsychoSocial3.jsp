	...
	<tr>
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.besoins",sWebLanguage)%>	
					</td>
				</tr>
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.repas",sWebLanguage)%>
					</td>
					<td class="admin2">
						...
						<div id="repas_block" style="display:none;">
							<br/><br/>
							<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.repas.suivi",sWebLanguage)%>
							<br/>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.eau.portable",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="sante_mutuelle1" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.santé.mutuelle.quelle",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="sante_mutuelle2" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.santé.mutuelle.couvre",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.transport",sWebLanguage)%>	
					</td>
				</tr>
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.moyen.transport",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MOYEN_TRANSPORT" property="itemId"/>]>.value">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.transport",sType,sWebLanguage,false,true)%>
		                </select>
		                <br/><br/>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.temps.transport",sWebLanguage)%>
					</td>
					<td class="admin2">
		...
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.adherence",sWebLanguage)%>	
					</td>
				</tr>
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.appris.statut",sWebLanguage)%>
					</td>
					<td class="admin2">
