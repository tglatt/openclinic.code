...
<!-- 
 ...
 -->
<%
	String accessright="occup.gitegaoutpatientfile";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table id="contentpane" style="vertical-align:top;" width="100%" border="0" cellspacing="0">
        <tr id="tr1-view">
            <td><%ScreenHelper.setIncludePage(customerInclude("healthrecord/manageGitegaOutpatientFileNewInclude.jsp"),pageContext);%></td>
        </tr>
