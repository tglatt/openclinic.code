...
<%=checkPermission(out,"mshp.csi.delivery","select",activeUser)%>
        	...
        	<td width="100%" valign='top'>
	        	<table width='100%'>
	        		...
	        		<tr>
			            ...
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MSAS_DELIVERIES_DELIVERYLOCATION", "gn.deliverylocation", sWebLanguage, "") %>
			            </td>
	        		</tr>
	        		<tr>
			            <td class='admin'><%=getTran(request,"web","childbirthtype",sWebLanguage)%>&nbsp;</td>
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MSAS_DELIVERIES_CHILDBIRTHTYPE", "msas.childbirthtype", sWebLanguage, "") %>
			            </td>
	        		...
	        		<tr>
			            ...
			            <td class="admin2" colspan='3'><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_DELIVERY_COMPLICATIONS_CHILD", 100, 1) %></td>
			        </tr>
	        		<%
	        		...
	        		<tbody id='child2' style='display: <%=sChild2Display%>'>
		        		<tr>
				            ...
				            <td class='admin'><%=getTran(request,"web","childstatus",sWebLanguage)%>&nbsp;</td>
				            <td class="admin2">
				                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MSAS_DELIVERIES_CHILDSTATUS_2", "msas.delivery.childstatus", sWebLanguage, "onchange='checkChildStatus();calculateBirths();'") %>
	        		...
	        		<tbody id='child3' style='display: <%=sChild3Display%>'>
		        		<tr>
				            ...
				            <td class='admin'><%=getTran(request,"web","childstatus",sWebLanguage)%>&nbsp;</td>
				            <td class="admin2">
				                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_MSAS_DELIVERIES_CHILDSTATUS_3", "msas.delivery.childstatus", sWebLanguage, "onchange='checkChildStatus();calculateBirths();'") %>
...
<script>
  function calculateBirths(){
	  ...
	  else if(document.getElementById("ITEM_TYPE_MSAS_DELIVERIES_CHILDSTATUS_3").value=='dcd'){
		  deceased++;
	  }
	  ...
	  else if(document.getElementById("ITEM_TYPE_MSAS_DELIVERIES_CHILDSTATUS_2").value=='dcd'){
		  deceased++;
	  }
	  ...
	  else if(document.getElementById("ITEM_TYPE_MSAS_DELIVERIES_CHILDSTATUS").value=='dcd'){
		  deceased++;
	  }
