    	...
    	<tr>
    		<td class='admin2' style='vertical-align:top'>
			    <table class="list" width="100%" cellspacing="1"> 
			        ...
			        <% if(tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DOC_URL").length()>0){ %>
				        <tr>
				            <td class="admin">URL&nbsp;</td>
				            <td class="adminblack">
				                &nbsp;<a style='color: yellow;font-weight: bolder' target="_blank" href="<%=tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DOC_URL")%>"><%=getTran(request,"web","gotodocument",sWebLanguage) %></a>
				            </td>
				        </tr>
			        <% } %>
