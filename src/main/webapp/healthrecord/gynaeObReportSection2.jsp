            ...
            <table cellspacing="1" cellpadding="0" width="100%" border="0" id="fetalDescription" class="list">
                <tr>
                    ...
                    <td class="admin2" width="<%=sTDAdminWidth%>">
                        <input id="ac_ITEM_TYPE_OBREPORT_LMP" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_LMP")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_LMP" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_LMP%>">
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_EDD" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_EDD")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_EDD" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_EDD%>">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_GA" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_GA")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_GA" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_GA%>">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE1" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE1")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE1" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE1%>">
                        <script>writeMyDate("ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE1", "<c:url value="/_img/icons/icon_agenda.png"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE2" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE2")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE2" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE2%>">
                        <script>writeMyDate("ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE2", "<c:url value="/_img/icons/icon_agenda.png"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE3" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE3")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE3" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE3%>">
                        <script>writeMyDate("ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_DATE3", "<c:url value="/_img/icons/icon_agenda.png"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
                    </td>
                </tr>
                <tr class="admin">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC1" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC1")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC1" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC1%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC2" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC2")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC2" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC2%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC3" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC3")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC3" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_FETAL_BIOMETRY_HC3%>" onblur="isNumber(this);">
                    </td>
                </tr>
                <%--                            FETAL BIOMETRY AC                          --%>
                <tr>
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD1" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD1")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD1" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD1%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD2" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD2")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD2" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD2%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD3" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD3")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD3" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_LEFT_UTERINE_ARTERY_SD3%>" onblur="isNumber(this);">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD1" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD1")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD1" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD1%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD2" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD2")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD2" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD2%>" onblur="isNumber(this);">
                    </td>
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD3" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD3")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD3" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_RIGHT_FETAL_CAROTIS_SD3%>" onblur="isNumber(this);">
                    </td>
                </tr>
                <%--                                           DUCTUS VENOSUS                             --%>
                <tr class="admin">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <input id="ac_ITEM_TYPE_OBREPORT_CALC_CI_BPD_OFD" size="20" <%=setRightClick(session,"ITEM_TYPE_OBREPORT_CALC_CI_BPD_OFD")%> type="text" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OBREPORT_CALC_CI_BPD_OFD" property="itemId"/>]>.value" value="<%=sITEM_TYPE_OBREPORT_CALC_CI_BPD_OFD%>" onblur="isNumber(this);"> %
                    </td>
                     <td class="admin" colspan="1"/>
                    <td class="admin2" colspan="1"/>
                </tr>
