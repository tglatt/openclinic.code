...
<div id='divcontent' style="overflow-y: scroll;">    
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SIGNSONADMISSION", "yesno", sWebLanguage, "onclick='triage();'") %>
        	</td>
        	...
        	<td colspan='8'>
        		<table width='100%'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ABDOMINALPAIN", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","abnormalxray",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ABNORMALXRAY", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","ards",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ARDS", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","chestpain",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHESTPAIN", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHILLS", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","conjunctivalinjection",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CONJUNCTIVALINJECTION", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","cough",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_COUGH", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","diarrhea",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DIARRHEA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DYSPNEA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","fatigue",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_FATIGUE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","fever",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_FEVER", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","lungfluid",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LUNGFLUID", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_xrayfluid", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","headache",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEADACHE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","arthritis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ARTHRITIS", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","malaise",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_MALAISE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_MUSCLEPAIN", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","nausea",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NAUSEA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","irritability",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_IRRITABILITY", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","pharyngealexudate",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_PHARYNGEALEXUDATE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_PNEUMONIA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","rapidbreathing",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RAPIDBREATHING", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","runningnose",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RUNNINGNOSE", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","pharyngitis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_PHARYNGITIS", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_VOMITING", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","coma",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_COMA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
			        	</td>
			        	<td class='admin2topright'>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","labcontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LABCONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","respcontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RESPCONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","samplecontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SAMPLECONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top' width='1%'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CLOSECONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","neighborhoodcontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' width='1%'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NEIGHBORHOOD", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","deadcontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' width='1%'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DEADCONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright''>
			        		<%=getTran(request,"covid","needlecontact",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' width='1%'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NEEDLECONTACT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEALTHFACILITYVISIT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","animalmarketvisit",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' colspan="5">
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ANIMALMARKETVISIT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SOCIALEVENTVISITED", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2top' colspan="6">
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_TRAVEL", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2top' colspan="6">
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_BATS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","snakes",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SNAKES", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","camels",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CAMELS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","otheranimals",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_OTHERANIMALS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_BUTCHERING", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","sickanimals",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SICKANIMALS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","rawmeat",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RAWMEAT", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","rawmeatinfected",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RAWMEATINFECTED", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        ...
			        <tr>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_TUBERCULOSIS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","asplenia",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ASPLENIA", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hepatitis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEPATITIS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","diabetes",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DIABETES", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_IMMUNODEFICIENCYNONHIV", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hiv",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HIV", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","congenitalsyphilis",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SYPHILIS", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","down",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DOWN", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIVERDISEASE", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","malignancy",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_MALIGNANCY", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","chronicheartfailure",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICHEARTFAILURE", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","chroniclungdisease",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICLUNGDISEASE", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			        	...
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RENALDISEASE", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","neurologicdisease",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NEUROLOGICDISEASE", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        	<td class='admin2topright'>
			        		<%=getTran(request,"covid","hypertension",sWebLanguage) %>
			        	</td>
			        	<td class='admin2top' colspan='3'>
			        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HYPERTENSION", "yesnounknown", sWebLanguage, "") %>
			        	</td>
			        </tr>
			        <tr>
			        	<td class='admin2topright'>
			       		...
			       		<td colspan='8'>
			       			<table class="list" width="100%" cellspacing="1" cellpadding='0'>
						        ...
						        <tr>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_SHOCK", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright' width='15%'>
						        		<%=getTran(request,"covid","aspiration",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_ASPIRATION", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright' width='15%'>
						        		<%=getTran(request,"covid","sepsis",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_SEPSIS", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright' width='15%'>
						        		<%=getTran(request,"covid","pneumonia",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_PNEUMONIA", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright' width='15%'>
						        		<%=getTran(request,"covid","pancreatitis",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_PANCREATITIS", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
						        	<td class='admin2topright'>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_BRAININJURY", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","smokeinhalation",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_SMOKEINHALATION", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","neardrowning",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_NEARDROWNING", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","lungcontusion",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_LUNGCONTUSION", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","multiplefractures",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_MULTIPLEFRACTURES", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
						        ...
						        <tr>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_ORTHOSPINE", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","acuteabdomen",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_ACUTEABDOMEN", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","cardiac",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_CARDIAC", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","aorticvascular",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top' colspan='3'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_AORTICVASCULAR", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
						        ...
						        <tr>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_EMERGENCYSURGERY", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","alcoholabuse",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_ALCOHOLABUSE", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","obesity",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_OBESITY", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","chemotherapy",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_CHEMOTHERAPY", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","diabetes",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_DIABETES", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
						        	<td class='admin2topright'>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_HIGHRESPIRATORYRATE", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","lowoxygensatuartion",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_LOWOXYGENSATURATION", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","highoxygenneed",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_HIGHOXYGENNEED", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","hypoalbuminemia",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_HYPOALBUMINEMIA", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","acidosis",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIPS_ACIDOSIS", "yesno", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
			       		...
			       		<td colspan='8'>
			       			<table class="list" width="100%" cellspacing="1" cellpadding='0'>
						        <tr>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEPATOMEGALIA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","splenomegalia",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SPLENOMEGALIA", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        ...
						        <tr>
						        	...
						        	<td class='admin2top'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEMOGAGOCYTOSIS", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        	<td class='admin2topright'>
						        		<%=getTran(request,"covid","immunosuppression",sWebLanguage) %>
						        	</td>
						        	<td class='admin2top' colspan='3'>
						        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_IMMUNOSUPPRESSION", "yesnounknown", sWebLanguage, "onclick='triage()'") %>
						        	</td>
						        </tr>
						        <tr>
						        	<td class='admin2topright'>
