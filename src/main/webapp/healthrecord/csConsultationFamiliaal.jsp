...
<%!
    ...
    private String addKinderen(int iTotal, String sTmpKinderenGeboortejaar, String sTmpKinderenGeslacht, String sTmpKinderenFirstname, String sWebLanguage) {
        ...
        sOut.append("<tr id='rowKinderen" + iTotal + "'>")
            .append("<td width='36'>")
            .append("<a href='javascript:deleteKinderen(rowKinderen" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup", "medwan.common.delete", sWebLanguage) + "' border='0'></a> ")
            .append("<a href='javascript:editKinderen(rowKinderen" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup", "medwan.common.edit", sWebLanguage) + "' border='0'></a>")
            .append("</td>");
    ...
    private String addFami(int iTotal, String sTmpFamiDate, String sTmpFamiDescr, String sTmpFamiVerwantschap, String sWebLanguage) {
        return "<tr id='rowFami" + iTotal + "'>"
                + "<td width='36'>"
                + " <a href='javascript:deleteFami(rowFami" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup", "medwan.common.delete", sWebLanguage) + "' border='0'></a> "
                + " <a href='javascript:editFami(rowFami" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup", "medwan.common.edit", sWebLanguage) + "' border='0'></a>"
                + "</td>"
                + "<td>&nbsp;" + sTmpFamiDate + "</td>"
                + "<td>&nbsp;" + sTmpFamiDescr + "</td>"
