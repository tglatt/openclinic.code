...
<script>
  ...
  function addICD10(code,label){
    window.opener.icpccodes.innerHTML = window.opener.icpccodes.innerHTML+"<span id='"+code+"'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' onclick='window."+code+".innerHTML=\"\";'/> <input type='hidden' name='ICD10Code"+code+"' value='medwan.common.true'/>"+code+"&nbsp;"+label+"<br/></span>";
  }
