...
<%=checkPermission(out,"occup.neurologycarefile","select",activeUser)%>
			...
			<td style="vertical-align:top;padding:0;" class="admin2" width="50%">
				<table class="list" width="100%" cellspacing="1">
				    ...
				    <tr>
				        ...
				        <td class="admin2">
				            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick(session,"ITEM_TYPE_NEUROLOGY_CAREFILE_PROBLEMCONTEXT")%> class="text" cols="50" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEUROLOGY_CAREFILE_PROBLEMCONTEXT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEUROLOGY_CAREFILE_PROBLEMCONTEXT" property="value"/></textarea>
				        </td>
				    </tr>
				    ...
				    <tr>
				        ...
				        <td class="admin2">
				            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick(session,"ITEM_TYPE_NEUROLOGY_CAREFILE_FAMILIALHISTORY_SHORT")%> class="text" cols="50" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEUROLOGY_CAREFILE_FAMILIALHISTORY_SHORT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEUROLOGY_CAREFILE_FAMILIALHISTORY_SHORT" property="value"/></textarea>
				        </td>
				    </tr>
