                        ...
                        if("abcdefghijklmnopqrstuvwxyz".indexOf(code.code.substring(0, 1).toLowerCase())>-1){
	                        ...
	                        //if(!oldcodelabel.equalsIgnoreCase(code.label)){
	                            ...
	                            if(code.code.length()>=5 || code.code.startsWith("I")){
	                                ...
	                                out.print(" <td onclick='addICPC(\""+code.code+"\",\""+ScreenHelper.removeAccents(code.label)+"\");'>"+code.code+"</td>");
	                                out.print(" <td onclick='addICPC(\""+code.code+"\",\""+ScreenHelper.removeAccents(code.label)+"\");'>"+code.label+"</td>");
	                                out.print("</tr>");
	                            }
                            //}
	                     }
	                        ...
	                        if("abcdefghijklmnopqrstuvwxyz".indexOf(code.code.substring(0, 1).toLowerCase())>-1){
			                    ...
			                    if(!oldcodelabel.equalsIgnoreCase(code.label)){
			                        ...
			                        if(code.code.length()>=3){
			                            ...
			                            out.print(" <td onclick='addICD10(\""+code.code+"\",\""+ScreenHelper.removeAccents(code.label)+"\");'>"+code.code+"</td>");
			                            out.print(" <td onclick='addICD10(\""+code.code+"\",\""+ScreenHelper.removeAccents(code.label)+"\");'>"+code.label+"</td>");
			                            out.print("</tr>");
			                        }
			                    }
	                        }
