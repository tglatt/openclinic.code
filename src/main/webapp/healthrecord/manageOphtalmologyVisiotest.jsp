...
<table width="100%" cellspacing="1" border="0" class="list">
   ...
   <%-- VOORGESCHREVEN CORRECTIE --%>
    ...
    <tr>
        ...
        <td class="admin2" colspan="3">
            ...
            <br>
            <input <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL")%> type="radio" onDblClick="uncheckRadio(this);" id="movi_r1" tabindex="20" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL;value=1" property="value" outputString="checked"/> value="1">
            <%=getLabel(request,"Web","yes",sWebLanguage,"movi_r1")%>
            <input <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL")%> type="radio" onDblClick="uncheckRadio(this);" id="movi_r2" tabindex="21" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_EQUAL;value=0" property="value" outputString="checked"/> value="0">
    ...
    <tr>
        ...
        <td class="admin2">
            <%=getTran(request,"web.occup","delhaize.healthrecord.ophtalmology.av.verbetering",sWebLanguage)%>
            <br>
            <input <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER")%> type="radio" onDblClick="uncheckRadio(this);" id="movi_r7" tabindex="56" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER;value=1" property="value" outputString="checked"/> value="1">
            <%=getLabel(request,"Web","yes",sWebLanguage,"movi_r7")%>
            <input <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER")%> type="radio" onDblClick="uncheckRadio(this);" id="movi_r8" tabindex="57" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_OD_CLOSE_WITH_BETTER;value=0" property="value" outputString="checked"/> value="0">
    ...
    <tr>
        ...
        <td class='admin2' style="vertical-align:top;">
            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_FAR")%> class="text" cols="40" rows="2" tabindex="24" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_FAR" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_FAR" property="value"/></textarea>
        </td>
        <td class='admin2' style="vertical-align:top;">
            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_MIDDLE")%> class="text" cols="40" rows="2" tabindex="42" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_MIDDLE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_MIDDLE" property="value"/></textarea>
        </td>
        <td class='admin2' style="vertical-align:top;">
            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_CLOSE")%> class="text" cols="40" rows="2" tabindex="58" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_CLOSE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OD_CLOSE" property="value"/></textarea>
        </td>
    </tr>
    <%--- linker oog -----------------------------------------------------------------------------%>
    <tr class="label">
   ...
   <tr>
       <td class="admin"><%=getTran(request,"web.occup","medwan.common.remark",sWebLanguage)%>&nbsp;</td>
        <td class="admin2" style="vertical-align:top;">
           <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_FAR")%> class="text" cols="40" rows="2" tabindex="31" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_FAR" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_FAR" property="value"/></textarea>
       </td>
        <td class="admin2" style="vertical-align:top;">
           <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_MIDDLE")%> class="text" cols="40" rows="2" tabindex="47" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_MIDDLE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_MIDDLE" property="value"/></textarea>
       </td>
        <td class="admin2" style="vertical-align:top;">
           <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_CLOSE")%> class="text" cols="40" rows="2" tabindex="63" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_CLOSE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_REMARK_OG_CLOSE" property="value"/></textarea>
       </td>
   </tr>
    <%--- binoculair -----------------------------------------------------------------------------%>
    <tr class="label">
