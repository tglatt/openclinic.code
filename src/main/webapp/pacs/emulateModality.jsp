		    ...
		    while (itr.hasNext()) {
		        ...
		        if (!item.isFormField() && item.getFieldName().equalsIgnoreCase("filename")) {
	                ...
	                if(SH.isAcceptableUploadFileExtension(fullFileName)){
						...
						//If TransferSyntaxUID is missing, add the default value for it
						if(obj.getString(Tag.TransferSyntaxUID)==null){
							obj.putString(Tag.TransferSyntaxUID, VR.LO, "1.2.840.10008.1.2");
						}
