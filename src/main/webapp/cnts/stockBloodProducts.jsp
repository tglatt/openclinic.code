...
<%
	...
	//Type of blood product is stored in oc_stock_location
	ps.setString(1,type);
		...
		<tr>
			...
			<td class='admin2'>
				...
				for(int n=0;n<productstocks.size();n++){
					...
					if(product!=null && stock.getServiceStock().isAuthorizedUser(activeUser.userid) && stock.getServiceStock().isReceivingUser(activeUser.userid)){
