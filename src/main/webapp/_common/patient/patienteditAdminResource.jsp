        ...
        <table border='0' width='100%' class="list" cellspacing="1" style="border-top:none;">
            <tr>
                ...
                <td class="admin2">
                    ...
                    <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchCategory('RCategory','RCategoryText');">
                    <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="PatientEditForm.RCategory.value='';PatientEditForm.RCategoryText.value='';">
