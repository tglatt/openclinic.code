...
<%!
    ...
    //--- WRITE MY ROW ----------------------------------------------------------------------------
    private String writeMyRow(String sType, String sID, String sWebLanguage, String sIcon, String sMode) {
...
<%
    ...
    if (sFindCode.length() > 0) {
        ...
        while (iter.hasNext()) {
            ...
            hSelected.put(sNomenclatureID, writeMyRow(sFindType, sNomenclatureID, sWebLanguage, "",sMode));
    ...
    //*** search on findText **********************************************************************
        ...
        while (iter.hasNext()) {
            ...
            set.add(labelid);
            hSelected.put(labelid, writeMyRow(sFindType, labelid, sWebLanguage, "",sMode));
            iTotal++;
        }
    }
    //*** empty search ****************************************************************************
