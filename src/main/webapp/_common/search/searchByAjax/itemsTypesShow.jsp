...
<%
        ...
        out.write("\n<li><a href='#' id='newTypeButton'> <img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTranNoLink("Web", "edit", sWebLanguage) + "' border='0'></a>&nbsp;&nbsp;<span id='newItemField'>" + getTran(request,"Web.manage", "addNewValue", sWebLanguage) + "</span> </li><br />");
        ...
        while (it.hasNext()) {
            ...
            if (!value.equals("")) {
                out.write("\n<li>");
                out.write("<a href=\"javascript:delValue('','" + itemid + "' );\" ><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTranNoLink("Web", "delete", sWebLanguage) + "' class='link' /></a> ");
                //out.write(" <img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web","edit",sWebLanguage)+"' border='0'> ");
