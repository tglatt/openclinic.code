    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="menu">    
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchProduct('SearchProductUid','SearchProductName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="productStockForm.SearchProductUid.value='';productStockForm.SearchProductName.value='';">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="productStockForm.SearchServiceUid.value='';productStockForm.SearchServiceName.value='';">
            </td>
        </tr>
