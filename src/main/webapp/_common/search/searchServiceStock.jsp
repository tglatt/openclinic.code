    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="menu">
        <tr height="23">
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchService('SearchServiceUid','SearchServiceName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="serviceStockForm.SearchServiceUid.value='';serviceStockForm.SearchServiceName.value='';">
            </td>
        </tr>
        ...
        <tr height="23">
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchManager('SearchManagerUid','SearchManagerName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="serviceStockForm.SearchManagerUid.value='';serviceStockForm.SearchManagerName.value='';">&nbsp;&nbsp;&nbsp;
            </td>
