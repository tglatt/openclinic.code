...
<form name="SearchForm" method="POST" onSubmit="doFind();return false;" onkeydown="if(enterEvent(event,13)){doFind();}">
    ...
    <input type="hidden" name="begin" value="<%=sBegin%>">
    <input type="hidden" name="end" value="<%=sEnd%>">
...
<script>
    ...
    function populateCategory(sType,sID) {
        ...
        ajaxChangeSearchResults('_common/search/searchByAjax/searchCalendarResourceShow.jsp', SearchForm);
    }
    <%-- CLEAR SEARCH FIELDS --%>
