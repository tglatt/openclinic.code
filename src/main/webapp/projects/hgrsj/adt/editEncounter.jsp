...
<%
    ...
    if(sEditEncounterUID.trim().length()==0 && (activePatient.isDead()!=null && !activeUser.getAccessRightNoSA("deceasedpatient.add"))){
	    ...
	    if(sEditEncounterCategories.length()==0){
	    	sEditEncounterCategories=MedwanQuery.getInstance().getConfigString("defaultEncounterCategory","");
	    }
	        ...
	        <tr>
	            ...
	            %>
	                <select class='text' id='EditEncounterType' name='EditEncounterType' onchange="checkEncounterType();">
	                	<option/>
	                    <%
	                        String encountertypes = MedwanQuery.getInstance().getConfigString("encountertypes","admission,visit,conservation");
	...
	<script>  
	  ...
	  function categoryCheck(){
	   	<%
	  		if(MedwanQuery.getInstance().getConfigInt("encounterDiseaseCategoryMandatory",0)==1){
