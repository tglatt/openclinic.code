...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
	    ...
	    <tr>
	    	<td class="admin2" colspan="2" style="vertical-align:top;padding:0px">
	    		<table width="100%">
					...
					<tr>
	    				<td colspan="3" class="admin"><%=getTran(request,"web","cdo.globe",sWebLanguage)%></td>
	    				<td colspan="1" class="admin2"><%=getTran(request,"web","cdo.cornee",sWebLanguage)%></td>
	    				<td colspan="5" class="admin2"><input  type="text" size="40" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CORNEE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CORNEE" translate="false" property="value"/>" <%=setRightClickMini("ITEM_TYPE_CDO_GLOBE_CORNEE")%>/></td>
	    			</tr>
					<tr>
	    				<td colspan="3" class="admin"></td>
	    				<td colspan="1" class="admin2"><%=getTran(request,"web","cdo.ca",sWebLanguage)%></td>
	    				<td colspan="5" class="admin2"><input  type="text" size="40" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CA" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CA" translate="false" property="value"/>" <%=setRightClickMini("ITEM_TYPE_CDO_GLOBE_CA")%>/></td>
	    			</tr>
					<tr>
	    				<td colspan="3" class="admin"></td>
	    				<td colspan="1" class="admin2"><%=getTran(request,"web","cdo.pupille",sWebLanguage)%></td>
	    				<td colspan="5" class="admin2"><input  type="text" size="40" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_PUPILLE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_PUPILLE" translate="false" property="value"/>" <%=setRightClickMini("ITEM_TYPE_CDO_GLOBE_PUPILLE")%>/></td>
	    			</tr>
					<tr>
	    				<td colspan="3" class="admin"></td>
	    				<td colspan="1" class="admin2"><%=getTran(request,"web","cdo.cristallin",sWebLanguage)%></td>
	    				<td colspan="5" class="admin2"><input  type="text" size="40" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CRISTALLIN" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_GLOBE_CRISTALLIN" translate="false" property="value"/>" <%=setRightClickMini("ITEM_TYPE_CDO_GLOBE_CRISTALLIN")%>/></td>
	    			</tr>
	    			<tr>
	    ...
	    <tr>
			<td class="admin" colspan="3" style="padding: 0px; vertical-align: top">
				<table width="100%">
					<tr>
						<td class="admin" colspan="3"><%ScreenHelper.setIncludePage(customerInclude("healthrecord/diagnosesEncodingNoRFE.jsp"),pageContext);%></td>
					</tr>
					<tr>
						<td class="admin" colspan="3"><%=getTran(request,"web","cdo.diagnostic",sWebLanguage)%>
					...
					<tr>
						<td class="admin" colspan="3"><%=getTran(request,"web","cdo.dr.medicalnote",sWebLanguage)%>
						<textarea  onKeyup="this.value=this.value.toUpperCase();resizeTextarea(this,10);" class="text" cols="60" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_DR_MEDICALNOTE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CDO_DR_MEDICALNOTE" translate="false" property="value"/></textarea>
						</td>
					</tr>					
				</table>
			</td>
