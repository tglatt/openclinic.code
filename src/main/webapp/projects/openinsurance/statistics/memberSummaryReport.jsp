...
<%
	...
	<table width='100%'>
		<tr>
			<td class='admin' nowrap><h3><%=getTran(request,"web","memberConsumption",sWebLanguage)%></h3></td>
			<td class='admin2' colspan='2'>
				<table width='100%'>
					<tr>
						...
						<td><center><u><%=getTran(request,"web","totalpopulation",sWebLanguage)%></u></center></td>
					</tr>
					<tr>
						<td width='33%'>
		...
		<tr>
			<td class='admin' nowrap><h3><%=getTran(request,"web","benificiaryConsumption",sWebLanguage)%></h3></td>
			<td class='admin2' colspan='2'>
				<table width='100%'>
					<tr>
						<td width='33%'>
...
<%
		...
		out.println("<script>window.opener.alert('"+getTran(request,"web","activepatient.not.insured",sWebLanguage)+"');window.close();</script>");
	}
%>