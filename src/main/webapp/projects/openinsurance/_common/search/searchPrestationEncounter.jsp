...
<script type="text/javascript">
    ...
    <form name='SearchForm' method="POST" onSubmit="doFind();" onkeydown="if(enterEvent(event,13)){doFind();}">
                        ...
                        <table border='0' width='100%' cellpadding="1" cellspacing="0">
                            ...
                            %>
                                        <tbody onmouseover='this.style.cursor="hand"' onmouseout='this.style.cursor="default"'>
                                            <tr class="admin">
                                                <td>ID</td>
                                                <td nowrap><%=getTran(request,"Web","start",sWebLanguage)%></td>
                                                <td nowrap><%=getTran(request,"Web","end",sWebLanguage)%></td>
                                                <td><%=getTran(request,"Web","service",sWebLanguage)%></td>
                                                <td nowrap><%=getTran(request,"Web.encounter","type",sWebLanguage)%></td>
                                            </tr>
        ...
        <%-- CLOSE BUTTON --%>
        <center>
            <input type="button" class="button" name="buttonclose" value='<%=getTran(null,"Web","Close",sWebLanguage)%>' onclick='window.close()'>
        </center>
