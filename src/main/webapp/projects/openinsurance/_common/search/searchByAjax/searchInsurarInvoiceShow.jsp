...
<div class="search">
    ...
    <table id="searchresults" class="sortable" width="100%" cellpadding="1" cellspacing="0"
        ...
        <tr class="admin">
            <td width="200" nowrap><%=
                HTMLEntities.htmlentities(getTran(request,"medical.accident", "insurancecompany", sWebLanguage))%>
            </td>
            <td width="100" nowrap><%=HTMLEntities.htmlentities(getTran(request,"web", "date", sWebLanguage))%>
            </td>
            <td width="110" nowrap><%=HTMLEntities.htmlentities(getTran(request,"web", "invoicenumber", sWebLanguage))%>
            </td>
            <td width="130" nowrap style="text-align:right;"><%=
                HTMLEntities.htmlentities(getTran(request,"web", "balance", sWebLanguage))%>nbsp;<%=
