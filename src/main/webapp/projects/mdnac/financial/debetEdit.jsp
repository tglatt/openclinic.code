...
<%=checkPermission(out,"financial.debet","edit",activeUser)%>
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchSupplier('EditSupplierUID','EditSupplierName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditForm.EditSupplierUID.value='';EditForm.EditSupplierName.value='';">
            </td>
        </tr>
        <tr>
