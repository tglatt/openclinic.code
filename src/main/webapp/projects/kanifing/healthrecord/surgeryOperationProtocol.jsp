		...
		<tr>
			<td style="vertical-align:top;padding:0;" class="admin2" width="50%">
			    <table class="list" cellspacing="1" cellpadding="0" width="100%">
			        ...
			        <tr>
			            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","hb",sWebLanguage)%></td>
			            <td class="admin2">
			                <%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_HB", 5, 0, 50, sWebLanguage) %> g/dl
			            </td>
			        </tr>
			        <tr>
			            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","asa",sWebLanguage)%></td>
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_ASA", "asa", sWebLanguage, "") %> 
			            </td>
			        </tr>
			        <tr>
			            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","urgency",sWebLanguage)%></td>
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_URGENCY", "surgery.urgency", sWebLanguage, "") %> 
			            </td>
			        </tr>
			        <tr>
			            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","anesthesia",sWebLanguage)%></td>
			            <td class="admin2">
			                <%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_ANESTHESIA", "surgery.anesthesia", sWebLanguage, "") %> 
			            </td>
			        </tr>
