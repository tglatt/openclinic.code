...
<% if(activeUser.getAccessRight("medical.select")){%>
    <table width="100%" class="list">
        ...
        <tr>
        	...
        	%>
            	<td colspan="6" valign="top" height="100%" width="50%"><%conditionalInclude("curative/medicationStatus.jsp",pageContext,"medication.medicationschema.select",activeUser);%></td>
            <%
        		}
        		else {
            %>
            	<td colspan="6" valign="top" height="100%" width="50%"><table width='100%'><tr class='admin'><td>&nbsp;</td></tr></table></td>
            <%
        		}
            %>
        <tr>
