...
<script>
  ...
  function checkSubmit(){
    ...
    if(maySubmit){
      openPopup("/_common/patient/patienteditSavePopup.jsp&PersonID=<%=(activePatient!=null?activePatient.personid:"")%>&Lastname="+PatientEditForm.Lastname.value+"&Firstname="+PatientEditForm.Firstname.value+"&DateOfBirth="+PatientEditForm.DateOfBirth.value+"&NatReg="+PatientEditForm.NatReg.value+"&ts=<%=getTs()%>");
    }
