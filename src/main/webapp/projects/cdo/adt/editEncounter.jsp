...
%>
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
       ...
       <tr id="Service">
        ...
        <%-- transfer --%>
       <tr id="transfer" style="visibility:hidden;">
        ...
        <%-- bed --%>
        <tr id="Bed" style="visibility:hidden;">
        ...
        <tr id="internaltransfers" style="visibility:hidden;">
        ...
        <tr id="Destination" style="visibility: hidden;">
...
<script>
    ...
    function checkEncounterType(){
        if(EditEncounterForm.EditEncounterType.value == "admission"){
            ...
            hide께께께께께께께께께께께께께께께께께께께께께께께께께	("internaltransfers");
        }
    }
