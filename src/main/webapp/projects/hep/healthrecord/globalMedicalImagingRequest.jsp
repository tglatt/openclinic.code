...
<form name="transactionForm" id="transactionForm" method="POST" action="<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>">
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <%
        	if(((TransactionVO)transaction).getTransactionId()>-1){
        %>
        <tr>
        	<td class='admin'><a style='font-weight: bold' href='javascript:linkImages()'><%=getTran(request,"web","linkedimages",sWebLanguage) %></a></td>
        	<td class='admin2' colspan='3'>
            	...
            	<table width='100%'>
            		<tr>
            			<td class="admin2" nowrap>
            				<%=ScreenHelper.writeDefaultNomenclatureField(session, (TransactionVO)transaction, "ITEM_TYPE_MIR2_TYPE", "mir_type", 40, sWebLanguage, sCONTEXTPATH, "") %>
			            </td>
			        </tr>
				  <%-- DHIS2 CODE --%>
				  <%	if(MedwanQuery.getInstance().getConfigInt("enableDHIS2",0)==1){ %>
            ...
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            <textarea id="protocol" onKeyup="resizeTextarea(this,10);limitChars(this,5000);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL" property="value"/></textarea>
                        </td>
                    </tr>
            ...
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
                    ...
                    <tr>
                        ...
                        <td class="admin"><%=getTran(request,"Web.Occup",sPREFIX+"item_type_mir_protocol",sWebLanguage)%></td>
                        <td class="admin2">
                            <textarea id="protocol2" onKeyup="resizeTextarea(this,10);limitChars(this,255);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL2" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL2" property="value"/></textarea>
                        </td>
                    </tr>
    ...
    <table class="list" width="100%" cellspacing="1" id="demande3" style="display:none;">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup",sPREFIX+"item_type_mir_type",sWebLanguage)%></td>
            <td class="admin2" nowrap>
   				<%=ScreenHelper.writeDefaultNomenclatureField(session, (TransactionVO)transaction, "ITEM_TYPE_MIR2_TYPE3", "mir.type", 40, sWebLanguage, sCONTEXTPATH, "") %>
            </td>
        ...
        <tr>
            ...
            <td class="admin"><%=getTran(request,"Web.Occup","examinationreason",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
                <textarea id="reason3" onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_MIR2_EXAMINATIONREASON3")%> class="text" cols="50" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_EXAMINATIONREASON3" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_EXAMINATIONREASON3" property="value"/></textarea>
            </td>
        </tr>
            ...
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
                    <tr>
                        ...
                        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.reason",sWebLanguage)%></td>
                        <td class="admin2">
                            <textarea id="executionreason3" onKeyup="resizeTextarea(this,10);limitChars(this,255);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OTHER_REQUESTS_PRESTATION_REASON3" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OTHER_REQUESTS_PRESTATION_REASON3" property="value"/></textarea>
                        </td>
                    </tr>
            ...
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
                    ...
                    <tr>
                        ...
                        <td class="admin"><%=getTran(request,"Web.Occup",sPREFIX+"item_type_mir_protocol",sWebLanguage)%></td>
                        <td class="admin2">
                            <textarea id="protocol4" onKeyup="resizeTextarea(this,10);limitChars(this,255);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL4" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL4" property="value"/></textarea>
                        </td>
                    </tr>
    ...
    <table class="list" width="100%" cellspacing="1" id="demande5" style="display:none;">
        ...
        <tr>
            ...
            <td class="admin"><%=getTran(request,"Web.Occup","examinationreason",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
                <textarea id="reason5" onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_MIR2_EXAMINATIONREASON5")%> class="text" cols="50" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_EXAMINATIONREASON5" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_EXAMINATIONREASON5" property="value"/></textarea>
            </td>
        </tr>
            ...
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
                    <tr>
                        ...
                        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.reason",sWebLanguage)%></td>
                        <td class="admin2">
                            <textarea id="executionreason5" onKeyup="resizeTextarea(this,10);limitChars(this,255);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OTHER_REQUESTS_PRESTATION_REASON5" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OTHER_REQUESTS_PRESTATION_REASON5" property="value"/></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="admin"><%=getTran(request,"Web.Occup",sPREFIX+"item_type_mir_protocol",sWebLanguage)%></td>
                        <td class="admin2">
                            <textarea id="protocol5" onKeyup="resizeTextarea(this,10);limitChars(this,255);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL5" property="itemId"/>]>.value" class="text" rows="2" cols="50"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_PROTOCOL5" property="value"/></textarea>
                        </td>
                    </tr>
...
<IFRAME style="display:none" id='hf2' name="hidden-form2"></IFRAME>
...
<script>
  ...
  function addDemand(){
    ...
    doModified("modified"+iDemand,"modifiedreason"+iDemand);
    doExecution("executionreason"+iDemand,!document.getElementById("rbexecutionno"+iDemand).checked);
  ...
  function linkImages(){
	    var url = "<c:url value='/healthrecord/linkImages.jsp'/>?ts="+new Date().getTime()+"&serverid=<%=((TransactionVO)transaction).getServerId()%>&transactionid=<%=((TransactionVO)transaction).getTransactionId()%>";
	    Modalbox.show(url,{title:'<%=getTranNoLink("web","linkedimages",sWebLanguage)%>',width:500,height:500},{evalScripts:true});
  }
  
  function loadLinkedImages(){
	    var params = "serverid=<%=((TransactionVO)transaction).getServerId()%>&transactionid=<%=((TransactionVO)transaction).getTransactionId()%>";
		var url = "<%=sCONTEXTPATH%>/pacs/loadLinkedImages.jsp";
		new Ajax.Request(url,{
		method: "POST",
		parameters: params,
		onSuccess: function(resp){
			document.getElementById('linkedimages').innerHTML=resp.responseText;
		}
		});
  }
  ...
  function saveLinks(){
	  ...
	  for(n=0;n<elements.length;n++){
		  if(elements[n].name && elements[n].name.indexOf("lcb_")>-1){
			  if(elements[n].checked){
				  link+=elements[n].name.replace("lcb_","")+";";
			  }
			  else {
				  unlink+=elements[n].name.replace("lcb_","")+";";
			  }
		  }
	  }
	  var params = "link="+link+"&unlink="+unlink+"&orderuid=<%=((TransactionVO)transaction).getServerId()+"."+((TransactionVO)transaction).getTransactionId()%>";
	  var url = "<%=sCONTEXTPATH%>/pacs/setLinkedImages.jsp";
	  new Ajax.Request(url,{
	  method: "POST",
	  parameters: params,
	  onSuccess: function(resp){
