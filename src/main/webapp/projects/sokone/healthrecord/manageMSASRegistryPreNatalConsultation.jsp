        	...
        	<td width="100%" valign='top'>
	        	...
	        	<tr>
			            ...
			            <td class="admin2" >
			           	...
			           	<!-- debut : ajout ITEM ITEM_TYPE_MSAS_PRENATAL_DDR -->
			      <tr>
			        <td class='admin'><%=getTran(request,"web","ddr",sWebLanguage)%>&nbsp;</td>
			            <td class='admin2' colspan='4'> <%=SH.writeDefaultDateInput(session, (TransactionVO)transaction, "ITEM_TYPE_MSAS_PRENATAL_DDR", sWebLanguage, sCONTEXTPATH) %></td>
			      </tr>
			      	<!-- FIN : ajout ITEM ITEM_TYPE_MSAS_PRENATAL_DDR -->
	        		<tr>
