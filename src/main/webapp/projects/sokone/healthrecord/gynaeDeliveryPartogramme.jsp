	...
	var ds= [
		 	...
		 	},
	    	{
		 	...
		 	},
		 	{
		 		...
		 		borderWidth: 1,
		 		pointRadius: 0,
		     	data: [{x: getStartDate().getTime(), y: <%=SH.ci("pgDilatationStartLevel",4)%>},{x: getStartDate().getTime()+<%=SH.ci("pgDilatationEndHours",6)%>*hour, y: 10}],
		 	},
		 	{
		 		label: '',
		     	backgroundColor: 'rgba(0,0,0,0)',
		 		...
		 		borderWidth: 1,
		 		pointRadius: 0,
		     	data: [{x: getStartDate().getTime()+<%=SH.ci("pgEngagementStartHours",4)%>*hour, y: <%=SH.ci("pgEngagementStartLevel",4)%>},{x: getStartDate().getTime()+<%=SH.ci("pgEngagementEndHours",10)%>*hour, y: 10}],
		 	},
	];
