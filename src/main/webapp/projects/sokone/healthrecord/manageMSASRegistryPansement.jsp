...
<!-- 
 ...
 -->
<%
	String accessright="msas.pansement";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <% TransactionVO tran = (TransactionVO)transaction; %>
  		 ...
  		 <tr class='admin'><td colspan='4'><%=getTran(request,"web","pansement",sWebLanguage) %></td></tr>
  		 
	     <tr>
           	  	<td class="admin" > <%=getTran(request,"web","natureleision",sWebLanguage)%></td>
           		<td class="admin2" colspan='4' > <%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_PANSEMENT_NATURE_LEISION",50, 2)%></td>
            	
          <tr>        
	     <tr>         
             <td class="admin" > <%=getTran(request,"web","traitement",sWebLanguage)%></td>
            <td class="admin2"> <%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_PANSEMENT_TRAITEMENT",50, 2)%></td>
             <td class="admin" > <%=getTran(request,"web","observation",sWebLanguage)%></td>
            <td class="admin2"> <%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_PANSEMENT_OBSERVATION",40, 2)%></td>
