...
<%@page errorPage="/includes/error.jsp" %>
    <bean:define id="transaction" name="be.mxs.webapp.wl.session.SessionContainerFactory.WO_SESSION_CONTAINER" property="currentTransactionVO"/>
        ...
        <tr>
         ...
         <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk", "presentation", sWebLanguage)%>
            </td>
            <td class="admin2" colspan='3'>
                <select <%=setRightClick(session,"ITEM_TYPE_DELIVERY_PRESENTATION")%> id="EditReanimationDestination" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_PRESENTATION" property="itemId"/>]>.value" class="text">
                    <option/>
                    <%=ScreenHelper.writeSelect(request,"delivery.presentation", ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_PRESENTATION"), sWebLanguage)%>
                </select>
            </td>
        </tr>
        <%-- gender / weight --%>
                        ...
                        <td bgcolor="#EBF3F7">
                            <table bgcolor="white" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="admin2">
                                        <textarea id="malformation" onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_DELIVERY_CHILD_MALFORMATION")%> class="text" cols="30" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_CHILD_MALFORMATION" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_CHILD_MALFORMATION" property="value"/></textarea>
                                    </td>
                                </tr>
                                 <%-- cried   --%>
						        <tr>
						            <td class="admin"><%=getTran(request,"openclinic.chuk", "cried", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_CRIED", sWebLanguage, false, "", "") %>
						        </tr>
						         <%-- reamination --%>
						        <tr>
						    
						            <td class="admin"><%=getTran(request,"openclinic.chuk", "reamination", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_REAMINATION", sWebLanguage, false, "", "") %>
						        </tr>
						         <%-- KANOUROU --%>
						        <tr>
						         	<td class="admin"><%=getTran(request,"openclinic.chuk", "kangourou", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_KANGOUROU", sWebLanguage, false, "", "") %>
						 		  </tr>
						 		    <%--  REFERER --%>
						 		 <tr>
						 			<td class="admin"><%=getTran(request,"openclinic.chuk", "referal", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_REFERAL", sWebLanguage, false, "", "") %>    
						        </tr>
						         <%-- Soins immediat --%>
						        <tr>
						     		<td class='admin'><%=getTran(request,"openclinic.chuk","child.immediats",sWebLanguage)%>&nbsp;</td>
			            			<td class="admin2"><%=SH.writeDefaultCheckBoxes((TransactionVO)transaction, request, "delivery.child.immediats", "ITEM_TYPE_MSAS_CHILD_CARE_IMMEDIAT", sWebLanguage, false) %></td>
								</tr>
                                <%-- observation --%>
                                <tr>
        ...
        <tr>
            ...
            <td class="admin2" colspan='3'>
                <select <%=setRightClick(session,"ITEM_TYPE_DELIVERY_PRESENTATION2")%> id="EditReanimationDestination" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_PRESENTATION2" property="itemId"/>]>.value" class="text">
                    <option/>
                    <%=ScreenHelper.writeSelect(request,"delivery.presentation", ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_PRESENTATION2"), sWebLanguage)%>
                </select>
            </td>
        </tr>
        <%-- gender / weight --%>
                        ...
                        <td bgcolor="#EBF3F7">
                            <table bgcolor="white" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="admin2">
                                        <textarea id="malformation2" onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_DELIVERY_CHILD_MALFORMATION2")%> class="text" cols="30" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_CHILD_MALFORMATION2" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_CHILD_MALFORMATION2" property="value"/></textarea>
                                    </td>
                                </tr>
                                 <%-- cried   --%>
						        <tr>
						            <td class="admin"><%=getTran(request,"openclinic.chuk", "cried", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_CRIED2", sWebLanguage, false, "", "") %>
						        </tr>
						         <%-- reamination --%>
						        <tr>
						    
						            <td class="admin"><%=getTran(request,"openclinic.chuk", "reamination", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_REAMINATION2", sWebLanguage, false, "", "") %>
						        </tr>
						         <%-- KANOUROU --%>
						        <tr>
						         	<td class="admin"><%=getTran(request,"openclinic.chuk", "kangourou", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_KANGOUROU2", sWebLanguage, false, "", "") %>
						 		  </tr>
						 		    <%--  REFERER --%>
						 		 <tr>
						 			<td class="admin"><%=getTran(request,"openclinic.chuk", "referal", sWebLanguage)%></td>
						            <td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_DELIVERY_CHILD_REFERAL2", sWebLanguage, false, "", "") %>    
						        </tr>
						         <%-- Soins immediat --%>
						        <tr>
						     		<td class='admin'><%=getTran(request,"openclinic.chuk","child.immediats",sWebLanguage)%>&nbsp;</td>
			            			<td class="admin2"><%=SH.writeDefaultCheckBoxes((TransactionVO)transaction, request, "delivery.child.immediats", "ITEM_TYPE_MSAS_CHILD_CARE_IMMEDIAT2", sWebLanguage, false) %></td>
								</tr>
                                <%-- observation --%>
                                <tr>
                                    <td class="admin"><%=getTran(request,"openclinic.chuk", "observation", sWebLanguage)%>
