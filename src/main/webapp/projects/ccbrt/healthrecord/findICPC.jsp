...
<form name="icpcForm" method="post" onSubmit="doFind();">
    <table class='menu' width='100%' cellspacing="0">
        <tr>
        	<td colspan='3'>
	         	<table width='100%' cellspacing='0' cellpadding='0'>
		            ...
		            <td colspan='2'>
		                <input type='text' class='text' name='keywords' size='30' value="<%=request.getParameter("keywords")!=null?request.getParameter("keywords"):""%>" onblur="limitLength(this);" onKeyDown='if(enterEvent(event,13)){doFind();}'/>
		                <input class='button' type='button' name='findButton' onclick='doFind();' value='<%=getTranNoLink("Web","Find",sWebLanguage)%>'/>
					</td>
		            <td><%=HTMLEntities.htmlentities(getTranNoLink("Web","NHIF",sWebLanguage))%>&nbsp;&nbsp;</td>
					<td>
		                <input type='text' class='text' name='keywordsnhif' size='30' value="<%=request.getParameter("keywordsnhif")!=null?request.getParameter("keywordsnhif"):""%>" onblur="limitLength(this);" onKeyDown='if(enterEvent(event,13)){doFindNhif();}'/>
		                <input class='button' type='button' name='findNhifButton' onclick='doFindNhif();' value='<%=getTranNoLink("Web","Find",sWebLanguage)%>'/>
        ...
        <%
	        ...
	        String keywordsnhif = checkString(request.getParameter("keywordsnhif"));
            int foundRecords = 0;
        ...
        %><tbody class="hand"><%
                ...
                String oldcodelabel="";
                // Hier worden de geselecteerde ICD10-codes getoond
                codes = MedwanQuery.getInstance().findICD10CodesNhif(request.getParameter("keywordsnhif"),sWebLanguage);
