...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              +"<tr><td class='admin'>"+getTran(request,"web","department",sWebLanguage)+"</td><td class='admin2'>"+sRegions+"</td></tr>"
              ...
              +inputRow(request,"Web","municipality","PCity","AdminPrivate",apc.city,"T",true,false,sWebLanguage)
