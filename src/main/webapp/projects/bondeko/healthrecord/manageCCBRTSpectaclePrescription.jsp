			        ...
			        <tr>
			        	...
			        	<td>
			        		<table width='100%' cellspacing='0' cellpadding='0'>
			        			<tr>
			        				<td class="admin2"><b><%=getTran(request,"web.optical","vision.type.1",sWebLanguage)%></b>&nbsp;</td>
			        			...
			        			<tr>
			        				<%
										...
										String sphere_right2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OD_SPHERE2");
										String sphere_left2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OS_SPHERE2");
										String cylinder_right2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OD_CYLINDER2");
										String cylinder_left2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OS_CYLINDER2");
										String axis_right2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OD_AXIS2");
										String axis_left2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DISTANCE_OS_AXIS2");
										String add_right2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ADD_OD_SPHERE2");
										String add_left2 = ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ADD_OS_SPHERE2");
			        					...
			        					if(((TransactionVO)transaction).getTransactionId()<0){
			        						...
			        						sphere_right2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_RIGHT_1");
			        						sphere_left2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_LEFT_1");
			        						cylinder_right2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_RIGHT_2");
			        						cylinder_left2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_LEFT_2");
			        						axis_right2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_RIGHT_3");
			        						axis_left2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_LEFT_3");
			        						add_right2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_ADD_L");
			        						add_left2=MedwanQuery.getInstance().getLastItemValue(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTOMETRIST_REFRACTION_ADD_R");
			        			...
			        			<tr>
			        				<td class="admin2"><b><%=getTran(request,"web.optical","vision.type.2",sWebLanguage)%></b>&nbsp;</td>
			            			<td class="admin" width='16%'><%=getTran(request,"web.optical","sphere",sWebLanguage)%>&nbsp;</td>
			            			<td class="admin" width='16%'><%=getTran(request,"web.optical","cylinder",sWebLanguage)%>&nbsp;</td>
			            			<td class="admin" width='16%'><%=getTran(request,"web.optical","axis",sWebLanguage)%>&nbsp;</td>
			            			<td class="admin" width='16%'><%=getTran(request,"web.optical","add",sWebLanguage)%>&nbsp;</td>
