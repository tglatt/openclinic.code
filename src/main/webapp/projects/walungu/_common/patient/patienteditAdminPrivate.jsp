...
//              +inputRow(request,"Web","city","PCity","AdminPrivate",apc.city,"T",true, true,sWebLanguage)
              +"<tr><td class='admin'>"+getTran(request,"web","sector",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
              ...
              +inputRow(request,"Web","quarter","PCell","AdminPrivate",apc.cell,"T",true,false,sWebLanguage)
...
<script>
  function newAPC(){
    retVal = makeMsgBox("?","<%=getTran(request,"Web.admin","recuperation_old_data",sWebLanguage)%>",32,3,0,4096);
