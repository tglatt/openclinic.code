...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +"<tr><td class='admin'>"+getTran(request,"web","prefecture",sWebLanguage)+"</td><td class='admin2'>"+sDistricts+"</td></tr>"
              +"<tr><td class='admin'>"+getTran(request,"web","subprefecture",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
