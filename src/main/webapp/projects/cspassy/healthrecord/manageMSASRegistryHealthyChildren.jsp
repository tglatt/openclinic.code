        	...
        	<td valign='top'>
	        	<table width='100%'>
			        ...
			        <tr>
			        	...
			        	<td colspan='4'>
			        		<table width='100%'>
						        <tr class='admin'><td colspan='20'><%=getTran(request,"web","vaccinations",sWebLanguage) %></td></tr>
						        <tr>
			        ...
			        <tr>
			            <td class="admin"><%=getTran(request,"web","nutritionstatuschild",sWebLanguage)%>&nbsp;</td>
			         	<td class="admin2" colspan="4"  ><%= SH.writeDefaultCheckBoxes((TransactionVO)transaction, request, "msas.nutrition", "ITEM_TYPE_HEALTHYCHILDREN_NUTRITITION", sWebLanguage, false) %></td>					
					</tr>
					
					<tr>
						<td class="admin"><%=getTran(request,"web", "deworming", sWebLanguage)%></td>
			            <td class="admin2"><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "msas.deworming", "ITEM_TYPE_HEALTHYCHILDREN_DEPARASITAGE", sWebLanguage, false, "", "") %></td>
					...
					<tr>
					 <td class="admin"><%=getTran(request,"web","vitamina",sWebLanguage)%>&nbsp;</td>
			            <td class="admin2">
			            	<%= SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "msas.vitamina", "ITEM_TYPE_HEALTHYCHILDREN_VITAMINE", sWebLanguage, false,"","") %>
			            </td>
					...
					<tr>
						...
						<td class='admin2'><%=SH.writeDefaultCheckBox((TransactionVO)transaction, request, "medwan.common.true", "ITEM_TYPE_HEALTHYCHILDREN_MILDA", "") %></td>
