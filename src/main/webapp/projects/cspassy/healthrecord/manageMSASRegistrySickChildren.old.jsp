		        ...
		        <!-- Fin Ajout d'un item volet 1 (ITEM_TYPE_MSAS_VOLET1) -->
		        	...
		        	<tr>
			            ...
			            <td class="admin2">
			               ...
			               <br/> <%=getTran(request,"web","senttocommunitylevel",sWebLanguage) %>
			                 <%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "medwan.common.true", "ITEM_TYPE_MSAS_MALNUTRITION_SENTTOCOMMUNITYLEVEL", sWebLanguage, false, "", "") %>
			        ...
			        <tr>
			         ...
			         <tr>
			            ...
			            <td class="admin2" colspan="4" ><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_MSAS_SUSPICION_MALARIA", sWebLanguage, false, "", "") %>
			        </tr>  
			        <tr>   
