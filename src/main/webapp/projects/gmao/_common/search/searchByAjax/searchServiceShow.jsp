...
<%
    ...
    if(sFindCode.length() > 0){
        ...
        while(iter.hasNext()){
            ...
            set.add(getTranNoLink("service",sServiceID,sWebLanguage)+";"+sServiceID);
    ...
    //*** search on findText **********************************************************************
        ...
        while(iter.hasNext()){
            ...
            if(displayLabel){
                set.add(getTranNoLink("service",labelid,sWebLanguage)+";"+labelid);
...
<table width="100%" cellspacing="1">
    <%
        if(sViewCode.length() > 0){
	        ...
	        while(it.hasNext()){
	            element = it.next();
	            sOut.append((String) hSelected.get((element.toString()).split(";")[1]));
	        }
