...
<%
	...
	session.setAttribute("malariaDifferentialDiagnosis", "Error in processing request");
	String sDoc = MedwanQuery.getInstance().getConfigString("templateSource") + "/ikirezi/malaria.xml";
	SAXReader reader = new SAXReader(false);
	Document document = reader.read(new URL(sDoc));
	StringBuffer sInfo = new StringBuffer();
	sInfo.append(document.getRootElement().element("differentialdiagnosis").attributeValue(sWebLanguage)+";");
	...
	session.setAttribute("malariaDifferentialDiagnosis", s);
