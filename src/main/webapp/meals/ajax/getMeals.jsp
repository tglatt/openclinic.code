			...
			<table class="list" width="100%" cellpadding="1" cellspacing="1" onKeyDown="if(enterEvent(event,13)){searchMealsWindow();return false;}">
			    <tr>
			        ...
			        <td class="admin2">
			            ...
			            <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="document.getElementById('FindMealNameWindow').value='';document.getElementById('FindMealNameWindow').focus();">			      
			        </td>
			    </tr>
			</table>
			<br>
