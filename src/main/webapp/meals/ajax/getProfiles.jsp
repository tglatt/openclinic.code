			...
			<table class="list" width="100%" cellpadding="1" cellspacing="1" onKeyDown="if(enterEvent(event,13)){searchProfilesWindow();return false;}">
			    <tr>
			        ...
			        <td class="admin2">
			            ...
			            <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="$('FindProfileNameWindow').value='';$('FindProfileNameWindow').focus();">
			        </td>
			    </tr>
			</table>
			<br>
