			...
			<table class="list" width="100%" cellspacing="1" cellpadding="1" onKeyDown="if(enterEvent(event,13)){searchNutricientItemsWindow();return false;}">
			    ...
			    <tr>
			        ...
			        <td class="admin2">
			            ...
			            <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="FindNutricientNameWindow.value='';FindNutricientNameWindow.focus();">
			        </td>
			    </tr>
			</table>
	        <br>
