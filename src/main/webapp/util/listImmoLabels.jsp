    ...
    <table width="100%" border="0" class="list" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
				...
				<img src='_img/icons/icon_search.png' class='link' alt='<%=getTranNoLink("web","select",sWebLanguage)%>' onclick='searchService("immoService","immoServiceName");'>	
                <img src='_img/icons/icon_delete.png' class='link' alt='<%=getTranNoLink("web","clear",sWebLanguage)%>' onclick='document.getElementById("immoService").value="";document.getElementById("immoServiceName").value="";'>
            </td>
        </tr>
        <%-- location --%>
        <tr>
        ...
        <%
			while(rs.next()){
				...
				out.print("<tr class='list"+sClass+"' onmouseover='this.className=\"list_select\"' onmouseout='this.className=\"list"+sClass+"\"'>"+
				           "<td nowrap>"+
				      	    "<img src='_img/icons/icon_delete.png' class='link' title='"+getTranNoLink("web","delete",sWebLanguage)+"' onclick='deleteImmo("+sServerId+","+sObjectId+");'>"+
						    ...
						    "<img src='_img/icons/icon_edit.png' class='link' title='"+getTranNoLink("web","edit",sWebLanguage)+"' onclick='editImmo("+sServerId+","+sObjectId+");'>"+
						   "</td>"+
