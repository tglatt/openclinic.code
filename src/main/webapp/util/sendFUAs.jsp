...
<form name="transactionForm" method="post" action="util/testFUA.jsp">
	...
	<input class='button' name='submitButton' type='button' onclick='document.getElementById("sendfile").value="1";transactionForm.submit();' value='<%=getTranNoLink("web","send",sWebLanguage) %>'/>
