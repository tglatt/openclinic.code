                ...
                while(Occuprs.next()){
                    ...
                    %>
                        ...
                        <tr class="list<%=sClass%>">
                            <td width="25"><a href="#"><img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" border="0" alt="<%=getTranNoLink("web","delete",sWebLanguage)%>" onClick="askDelete('<%=checkString(Occuprs.getString("rowid"))%>');"></a></td>
