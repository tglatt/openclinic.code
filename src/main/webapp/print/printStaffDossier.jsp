...
<form name="printForm" id="printForm" method="POST">
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_4" id="section_4" value="on" class="hand" <%=(sSection4.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.contracts",sWebLanguage,"section_4")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_5" id="section_5" value="on" class="hand" <%=(sSection5.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.skills",sWebLanguage,"section_5")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_6" id="section_6" value="on" class="hand" <%=(sSection6.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.career",sWebLanguage,"section_6")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_7" id="section_7" value="on" class="hand" <%=(sSection7.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.disciplinaryRecord",sWebLanguage,"section_7")%>
             </td>
         </tr> 
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_8" id="section_8" value="on" class="hand" <%=(sSection8.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.leaves",sWebLanguage,"section_8")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_9" id="section_9" value="on" class="hand" <%=(sSection9.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.salary",sWebLanguage,"section_9")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_10" id="section_10" value="on" class="hand" <%=(sSection10.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.workschedule",sWebLanguage,"section_10")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_11" id="section_11" value="on" class="hand" <%=(sSection11.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","hr.trainingAndEducation",sWebLanguage,"section_11")%>
             </td>
         </tr>
         ...
         <tr>
             <td class="admin">
                 <input type="checkbox" name="section_12" id="section_12" value="on" class="hand" <%=(sSection12.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","signature",sWebLanguage,"section_12")%>
             </td>
         </tr>
         --%> 
