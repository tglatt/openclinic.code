	...
	if(sUserName.length()>0 && sPassword.length()>0){
		if(User.validate(sUserName, sPassword)){
			...
			if(user!=null && user.userid.length()>0 && User.hasPermission(user.userid,ScreenHelper.getSQLDate(new java.util.Date()))){
				...
				out.println("<script>window.location.href='"+sCONTEXTPATH+"/diagnostix/manageDiagnostix.jsp';</script>");
				out.flush();
			}
			else{
	...
	<body>
		<form name='transactionForm' method='post'>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			    <tr>
			        <td align="center" style="vertical-align:top;" width="1%"><br/><br/><br/>
						&nbsp;<br/><img height='100px' src='<%=MedwanQuery.getInstance().getConfigString("diagnostixAnalyzers",sCONTEXTPATH+"/_img/diagnostix_analyzers.png") %>'/>
						<br/>&nbsp;<br/>&nbsp;<br/>&nbsp;<br/>
			        </td>
			    </tr>
				<tr>
							...
							<table>
								...
								<tr>
									<td colspan='2' style='text-align: center'>
							            <img height='50px' src="<%=MedwanQuery.getInstance().getConfigString("diagnostixLoginLogo",sCONTEXTPATH+"/_img/diagnostix.png") %>" border="0"><br/>
							            <font style='font-size: 10px'>Diagnostix Europe: <a href='mailto:diagnostix@ict4d.be'>diagnostix@ict4d.be</a> - Diagnostix Grands Lacs: <a href='mailto:diagnostix.bi@ict4d.be'>diagnostix.bi@ict4d.be</a></font>
									</td>
								</tr>
							</table>
						</center>
