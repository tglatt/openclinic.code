...
<%=checkPermission(out,"medical.managecareprescriptionspopup","select",activeUser)%>
<%=sJSSORTTABLE%>
    ...
    if(sAction.startsWith("showDetails")){
        ...
        if(sAction.equals("showDetails") || sAction.equals("showDetailsAfterUpdateReject")){
            ...
            if(prescr!=null){
                ...
                // service stock name
                if(sSelectedServiceStockUid.length() > 0 && prescr.getServiceStock()!=null){
                ...
                %>
                    <table class="list" width="100%" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                <input type="text" maxlength="10" class="text" name="EditDateBegin" id="EditDateBegin" value="<%=sSelectedDateBegin%>" size="12" onblur="if(!checkDate(this)){alertDialog('Web.Occup','date.error');this.value='';}else{calculatePackagesNeeded(false);}if(isEndDateBeforeBeginDate()){displayEndBeforeBeginAlert();}" onKeyUp="if(this.value.length==10){calculatePackagesNeeded(false);}else{transactionForm.EditRequiredPackages.value='';}">
                                <img class="link" name="popcal" src="<%=sCONTEXTPATH%>/_img/icons/icon_agenda.png" alt="<%=getTranNoLink("Web","Select",sWebLanguage)%>" onclick="gfPop1.fPopCalendar(document.getElementById('EditDateBegin'));return false;">
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                <input type="text" maxlength="10" class="text" name="EditDateEnd" id="EditDateEnd" value="<%=sSelectedDateEnd%>" size="12" onblur="if(!checkDate(this)){alertDialog('Web.Occup','date.error');this.value='';}else{calculatePackagesNeeded(false);}if(isEndDateBeforeBeginDate()){displayEndBeforeBeginAlert();}" onKeyUp="if(this.value.length==10){calculatePackagesNeeded(false);}else{transactionForm.EditRequiredPackages.value='';}">
                                <img class="link" name="popcal" src="<%=sCONTEXTPATH%>/_img/icons/icon_agenda.png" alt="<%=getTranNoLink("Web","Select",sWebLanguage)%>" onclick="gfPop1.fPopCalendar(document.getElementById('EditDateEnd'));return false;">
