    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        %>
            ...
            <tr>
                ...
                <td class="admin2">
                    <input <%=flags.contains("F")?"checked":""%> type="radio" name="deshydration" id="deshydration" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input <%=flags.contains("f")?"checked":""%> type="radio" name="deshydration" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
