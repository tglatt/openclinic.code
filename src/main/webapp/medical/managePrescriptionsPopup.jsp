	...
	StringBuffer html = new StringBuffer();
        ...
        for(int i=0; i<objects.size(); i++){
        	try{
	            ...
	            if(prescr.getBegin()!=null && prescr.getPatientUid()!=null){
	            	activeEncounter = Encounter.getActiveEncounterOnDate(new java.sql.Timestamp(prescr.getBegin().getTime()), prescr.getPatientUid());
	            }
	            else{
	            	SH.syslog("Prescription error ["+prescr.getUid()+"]: prescr.getBegin()="+prescr.getBegin()+" and prescr.getPatientUid()="+prescr.getPatientUid());
	            }
