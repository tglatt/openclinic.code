...
<table width="100%" cellspacing="0" class="sortable" id="searchresults">
    ...
    <%
        ...
        while(centerIter.hasNext()){
		    ...
		    %>>
		        <td><img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" onClick="deleteService('<%=center.getUid()%>','<%=center.getVersion()%>')" title="<%=getTranNoLink("web","delete",sWebLanguage)%>"></td>
