...
public class GMAOInfrastructureCorrectiveInterventions extends DHIS2Plugin {
	...
	public Vector getResults(Date begin, Date end, Element dataset, Hashtable pluginParameters) {
		...
		int operations = be.openclinic.assets.Util.countCorrectiveInterventions("i",begin,end,"",rootService);
		int succesfuloperations = be.openclinic.assets.Util.countCorrectiveInterventions("i",begin,end,"ok",rootService);
