...
public class GMAOEquipmentPreventativeInterventions extends DHIS2Plugin {
	...
	public Vector getResults(Date begin, Date end, Element dataset, Hashtable pluginParameters) {
		...
		int operations = be.openclinic.assets.Util.countPreventativeInterventions("e",begin,end,rootService);
		int plannedoperations = be.openclinic.assets.Util.countPlannedPreventativeInterventions("e",begin,end,rootService);
		int expiredoperations = be.openclinic.assets.Util.countExpiredPlannedPreventativeInterventions("e",begin,end,rootService);
