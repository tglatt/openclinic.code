...
public class CsvInvoiceTanganyikaHospitalExtra {
	...
	public static String getOutput(javax.servlet.http.HttpServletRequest request){
		...
		String sOutput="ADHERENT;FACTURES;NUMERO_BC;BENEFICIAIRE;DATE;CLASSE;ACTE;QUANTITE;PRIX_UNITAIRE;TOTAL;ASSUREUR COMPL.;PATIENT;\r\n";
		if(invoiceuid!=null){
			try{
				...
				while(iInvoices.hasNext()){
					...
					sOutput+=ScreenHelper.getPriceFormat(debet.getExtraInsurarAmount())+";";
