...
public class PatientInvoice extends Invoice {
	...
	public static Hashtable<String,Double> getPatientInvoiceReductions(java.util.Date begin,java.util.Date end) {
    	Hashtable<String,Double> patientInvoices = new Hashtable<String,Double>();
        String sQuery = 	"select distinct oc_debet_patientinvoiceuid from oc_debets where"+
		  			" (oc_debet_patientinvoiceuid is not null and oc_debet_patientinvoiceuid<>'') and"+
		            " oc_debet_date between ? and ?";
        ...
        try {
	        ...
	        while(rs.next()){
	        	String uid = rs.getString("oc_debet_patientinvoiceuid");
	    		...
	    		for(int n=0;n<credits.size();n++){
	    			...
	    			if(SH.c(credit.getType()).equalsIgnoreCase("reduction")){
