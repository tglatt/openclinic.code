...
public class ReceiveSMS {
	public void receive(String name, String port, int baud, String brand, String model, String pin) throws Exception
	{
		...
		try
		{
			Debug.println("Example: Read messages from a serial gsm modem.");
			Debug.println(Library.getLibraryDescription());
			Debug.println("Version: " + Library.getLibraryVersion());
			...
			Debug.println();
			Debug.println("Modem Information:");
			Debug.println("  Manufacturer: " + gateway.getManufacturer());
			Debug.println("  Model: " + gateway.getModel());
			Debug.println("  Serial No: " + gateway.getSerialNo());
			Debug.println("  SIM IMSI: " + gateway.getImsi());
			Debug.println("  Signal Level: " + gateway.getSignalLevel() + " dBm");
			Debug.println("  Battery Level: " + gateway.getBatteryLevel() + "%");
			Debug.println();
			...
			// methods to be called in the event of message or voice call reception.
			 Debug.println("Now Sleeping - Hit <enter> to stop service.");
			 System.in.read();
			 System.in.read();
	...
	public class InboundNotification implements IInboundMessageNotification
	{
		public void process(AGateway gateway, MessageTypes msgType, InboundMessage msg)
		{
			...
			if (msgType == MessageTypes.INBOUND) Debug.println(">>> New Inbound message detected from Gateway: " + gateway.getGatewayId());
			else if (msgType == MessageTypes.STATUSREPORT) Debug.println(">>> New Inbound Status Report message detected from Gateway: " + gateway.getGatewayId());
		}
	}
	...
	public class CallNotification implements ICallNotification
	{
		...
		{
			Debug.println(">>> New call detected from Gateway: " + gateway.getGatewayId() + " : " + callerId);
		}
	}
	...
	public class GatewayStatusNotification implements IGatewayStatusNotification
	{
		...
		{
			Debug.println(">>> Gateway Status change for " + gateway.getGatewayId() + ", OLD: " + oldStatus + " -> NEW: " + newStatus);
		}
	}
	...
	public class OrphanedMessageNotification implements IOrphanedMessageNotification
	{
		...
		{
			Debug.println(">>> Orphaned message part detected from " + gateway.getGatewayId());
