	...
	public static Hashtable getLastSimpleValues(){
		...
		try{
			PreparedStatement ps = conn.prepareStatement("select * from dc_simplevalues a," +
					" (select max(dc_simplevalue_createdatetime) maxdate,dc_simplevalue_serverid,dc_simplevalue_parameterid from dc_simplevalues where dc_simplevalue_createdatetime>? group by dc_simplevalue_serverid,dc_simplevalue_parameterid) b " +
