...
public class Diagnosis extends OC_Object{
    ...
    public static boolean isNC(String transactionUid,String type, String code) {
    	boolean bNC=false;
    	Connection conn = SH.getOpenClinicConnection();
    	try {
			PreparedStatement ps = conn.prepareStatement("select * from oc_diagnoses WHERE oc_diagnosis_referenceuid=? and oc_diagnosis_codetype=? and oc_diagnosis_code=? and oc_diagnosis_nc=1");
    ...
    static public Vector<Diagnosis> getPatientDiagnoses(String code, String codetype, String patientuid, java.util.Date from, java.util.Date to) {
