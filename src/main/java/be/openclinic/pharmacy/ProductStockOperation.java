...
public class ProductStockOperation extends OC_Object{
    ...
    public static boolean postOperationToSyncServer(String productStockOperationUid) throws Exception {
        ...
        product.addElement("name").setText(SH.c(operation.getProductStock().getProduct().getName()));
        product.addElement("dose").setText(SH.c(operation.getProductStock().getProduct().getDose()));
        product.addElement("unit").setText(SH.c(operation.getProductStock().getProduct().getUnit()));
        ...
        if(operation.getSourceDestination().getObjectType().equalsIgnoreCase("patient") && operation.getSourceDestination().getObjectUid().length()>0) {
        	...
        	if(patient!=null && SH.c(patient.personid).length()>0) {
        		Element person = message.addElement("patient");
        		person.addAttribute("localid", patient.personid);
        		person.addElement("dateofbirth").setText(SH.c(patient.dateOfBirth));
        		person.addElement("gender").setText(SH.c(patient.gender));
        		person.addElement("lastname").setText(SH.c(patient.lastname));
        		person.addElement("firstname").setText(SH.c(patient.firstname));
        		person.addElement("telephone").setText(SH.c(patient.getActivePrivate().telephone)+" "+SH.c(patient.getActivePrivate().mobile));
        	}
        }
