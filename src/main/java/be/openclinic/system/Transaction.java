...
public class Transaction {
    ...
    public static String getTransactionContext(int iTransactionId,int iHealthRecordId, String sTransactionType){
        ...
        String sSelect = "SELECT " + ScreenHelper.getConfigString("valueColumn","value") +
        ...
        try{
            ...
            if(rs.next()){
                sContext = ScreenHelper.checkString(rs.getString(ScreenHelper.getConfigString("valueColumn","value")));
            }
        }catch(Exception e){
            e.printStackTrace();
        }finally{
