               ...
               result=TRANSACTION_DATE_NULL;
                ...
                try {
                    ...
                    if (oldRefdate==null || !oldRefdate.after(fileDate)){
                        ...
                        String valueColumn = MedwanQuery.getInstance().getConfigString("valueColumn","value");
                        String dateColumn = MedwanQuery.getInstance().getConfigString("dateColumn","date");
