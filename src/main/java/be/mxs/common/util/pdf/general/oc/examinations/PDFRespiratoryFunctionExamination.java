...
public class PDFRespiratoryFunctionExamination extends PDFGeneralBasic {
    ...
    private void getFEV1Data() throws Exception {
        ...
        sSelect.append("SELECT t.updateTime AS ut, i."+MedwanQuery.getInstance().getConfigString("valueColumn","value")+"  AS ow_value")
    ...
    private float getLength() throws SQLException {
        float rLength = 0;
        StringBuffer sSelect = new StringBuffer();
        sSelect.append("SELECT i."+MedwanQuery.getInstance().getConfigString("valueColumn","value")+" AS ow_value")
