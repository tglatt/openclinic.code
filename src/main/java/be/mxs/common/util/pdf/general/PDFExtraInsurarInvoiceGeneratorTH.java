...
public class PDFExtraInsurarInvoiceGeneratorTH extends PDFInvoiceGenerator {
	    ...
	    //--- CONSTRUCTOR -----------------------------------------------------------------------------
	    public PDFExtraInsurarInvoiceGeneratorTH(
	    		User user, 
	    		String sProject,
	    		String sPrintLanguage, 
	    		String PrintType){
	        this.user = user;
	    ...
	    public ByteArrayOutputStream generatePDFDocumentBytes(final HttpServletRequest req, String sInvoiceUid) throws Exception {
			...
			try{
	            ...
	            addHeading20(invoice);
	            addInsurarData20(invoice);
	            printInvoiceDetailed20(invoice);
	    ...
	    private void addHeading20(ExtraInsurarInvoice invoice) throws Exception {
	    ...
	    private void addInsurarData20(ExtraInsurarInvoice invoice){
	    ...
	    protected void printInvoiceDetailed20(ExtraInsurarInvoice invoice){
	        try {
				...
				cell.setBorder(PdfPCell.BOX);
				table.addCell(cell);
				cell = createBoldLabelCell(getTran("web","extrainsurar"), 10);
				cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
				cell.setBorder(PdfPCell.BOX);
				table.addCell(cell);
				...
				while(iInvoices.hasNext()){
					...
					cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
					table.addCell(cell);
					cell = createLabelCell(ScreenHelper.getPriceFormat(debet.getExtraInsurarAmount()+debet.getAmount()), 10);
					cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
					table.addCell(cell);
					cell = createLabelCell(ScreenHelper.getPriceFormat(debet.getExtraInsurarAmount()), 10);
					cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
					table.addCell(cell);
					...
					generaltotal+=debet.getExtraInsurarAmount()+debet.getAmount();
					generalinsurertotal+=debet.getExtraInsurarAmount();
					generalpatienttotal+=debet.getAmount();
					bctotal+=debet.getExtraInsurarAmount()+debet.getAmount();
					bcinsurartotal+=debet.getExtraInsurarAmount();
					bcpatienttotal+=debet.getAmount();
					classtotal+=debet.getExtraInsurarAmount()+debet.getAmount();
					classinsurartotal+=debet.getExtraInsurarAmount();
					classpatienttotal+=debet.getAmount();
