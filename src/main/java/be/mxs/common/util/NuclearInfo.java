...
public class NuclearInfo {
    ...
    public NuclearInfo(String badgePersonId, Date infoBegin, Date infoEnd) throws Exception {
        ...
        try{
            ...
            sbQuery.append("SELECT i."+MedwanQuery.getInstance().getConfigString("valueColumn","value")+" FROM Transactions tr, Items i")
            ...
            sbQuery = new StringBuffer();
            sbQuery.append("SELECT i."+MedwanQuery.getInstance().getConfigString("valueColumn","value")+"  FROM Transactions tr, Healthrecord hr, Items i")
            ...
            sbQuery = new StringBuffer();
            sbQuery.append("SELECT type,"+MedwanQuery.getInstance().getConfigString("valueColumn","value")+"  FROM Items")
