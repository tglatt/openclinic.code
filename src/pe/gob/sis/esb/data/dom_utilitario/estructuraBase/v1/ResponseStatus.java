...
public class ResponseStatus  extends pe.gob.sis.esb.data.dom_utilitario.estructuraBase.v1.ResponseData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sis.gob.pe/esb/data/dom_utilitario/estructuraBase/v1/", "ResponseStatus"));
    }
