    ...
    public static void main(final String[] args) {
        try {
            ...
            while (true) {
                ...
                PreparedStatement ps = conn.prepareStatement("select * from oc_pacs where oc_pacs_compresseddatetime is null and oc_pacs_updatetime<? order by oc_pacs_updatetime desc limit 520");
                ps.setTimestamp(1, SH.getSQLTimestamp(SH.dateAdd(new java.util.Date(), -SH.getTimeDay())));
