    ...
    public static TransactionVO fromXMLElement(Element transaction) {
    	...
    	if(eAnalyses!=null) {
    		...
    		while(analyses.hasNext()) {
	    		...
	    		a.setObjectid(SH.c(analysis.elementText("objectid")).length()==0?-1:Integer.parseInt(analysis.elementText("objectid")));
    ...
    public Element toXMLElement(){
        ...
        if(transactionType.equalsIgnoreCase("be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_LAB_REQUEST")) {
        	...
        	for(int n=0;n<analyses.size();n++) {
        		...
        		eAnalysis.addElement("objectid").setText(getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_LAB_OBJECTID"));
