...
public class ProductStock extends OC_Object implements Comparable {
    ...
    public Element getInitElement() {
        ...
        product.addElement("name").setText(SH.c(getProduct().getName()));
        product.addElement("dose").setText(SH.c(getProduct().getDose()));
        product.addElement("unit").setText(SH.c(getProduct().getUnit()));
    ...
    public void store() {
        ...
        try {
            if (this.getUid().equals("-1")) {
                ...
                else ps.setString(questionMarkIdx++, "type1native");
