							...
							while(interactionPairs.hasNext()){
								...
								while(interactionConcepts.hasNext()){
									...
									if(interactionConcept.element("sourceConceptItem")!=null){
										...
										String translation=GoogleTranslate.translate(MedwanQuery.getInstance().getConfigString("googleTranslateKey","-"),"en", language,sourceConceptItem.elementText("name"));
								...
								String translation=GoogleTranslate.translate(MedwanQuery.getInstance().getConfigString("googleTranslateKey","-"),"en", language,interactionPair.elementText("description"));
