...
public class Screen extends OC_Object {  
    ...
    public String display(String sWebLanguage, boolean cellsEditable, String sCONTEXTPATH){  
        ...
        for(int r=0; r<this.rows.size(); r++){
            ...
            sHtml.append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' class='link'")
                ...
                if(items!=null){
                    ...
                    while(itemIter.hasNext()){
                        ...
                        //*** date ***
                            ...
                            sHtml.append("<script>getMyDate('item_"+item.getItemTypeId()+"','"+sCONTEXTPATH+"/_img/icons/icon_agenda.png','"+ScreenHelper.getTran(null,"web","putToday",sWebLanguage)+"',true,false);</script>");
                        }
                        //*** select ***
