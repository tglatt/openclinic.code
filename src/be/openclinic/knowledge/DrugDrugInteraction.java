...
public class DrugDrugInteraction {
	...
	public String getLabel(String sLanguage){
		...
		if(s.equalsIgnoreCase(getInteractionId()+"")){
			s=GoogleTranslate.translate(MedwanQuery.getInstance().getConfigString("googleTranslateKey","-"), "fr", sLanguage, ScreenHelper.getTranNoLink("drugdruginteraction", getInteractionId()+"", "fr"));
	...
	public String getPrecaution(String sLanguage){
		...
		if(sLabel.equalsIgnoreCase(getInteractionId()+"")){
			sLabel=GoogleTranslate.translate(MedwanQuery.getInstance().getConfigString("googleTranslateKey","-"), "fr", sLanguage, ScreenHelper.getTranNoLink("drugdruginteraction.precaution", getInteractionId()+"", "fr"));
