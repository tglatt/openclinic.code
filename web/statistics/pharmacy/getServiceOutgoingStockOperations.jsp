...
<script>
  function printReport(){
	window.open('<c:url value="pharmacy/printServiceOutgoingStockOperations.jsp"/>?outputformat='+document.getElementById('outputformat').value+'&FindBeginDate='+document.getElementById('FindBeginDate').value+'&FindEndDate='+document.getElementById('FindEndDate').value+'&ServiceStockUid=<%=sServiceStockId%>');
	window.close();
  }
</script>