...
%>
	...
	<script>
		function printReport(){
			...
			window.open('<c:url value="pharmacy/printPoiServiceStockInventorySummary.jsp"/>?FindMonth='+document.getElementById('month').value+'&FindYear='+document.getElementById('year').value+'&ServiceStockUid='+servicestocks);
			window.close();
		}
