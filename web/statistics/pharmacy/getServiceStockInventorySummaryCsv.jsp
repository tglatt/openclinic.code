...
%>
	...
	<script>
		function printReport(){
			window.open('<c:url value="pharmacy/getProductionReports.jsp"/>?begin='+document.getElementById('FindBeginDate').value+'&end='+document.getElementById('FindEndDate').value+'&servicestockuid=<%=sServiceStockId%>&report=inventorySummaryReport');
			window.close();
		}
	</script>