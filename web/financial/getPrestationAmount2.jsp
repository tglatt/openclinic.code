		...
		for(int n=0;n<prestations.length;n++){
	        ...
	        if(insurance!=null && insurance.getInsurar()!=null && prestation.isVisibleFor(insurance.getInsurar(),encounter.getService())){
				...
				if(!Prestation.checkMaximumReached(activePatient.personid, rule, quantity)){
			        ...
			        prestationcontent+="<td "+(sCoverageInsurance2.length()>0?"class='strikeonly'":"")+"><input type='hidden' name='PPP_"+prestation.getUid()+"' id='PPP_"+prestation.getUid()+"' value='"+pa+"'/><span id='TPPP_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(dbl(pa))+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+(bCovered?" <img src='"+sCONTEXTPATH+"/_img/icons/icon_free.gif' title='"+getTranNoLink("web","forfait",sWebLanguage)+"'/>":"")+"</td>";
			        String sNegociate="";
			        ...
			        prestationcontent+="<td><input type='hidden' name='PPI_"+prestation.getUid()+"' id='PPI_"+prestation.getUid()+"' value='"+pi+"'/><span id='TPPI_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(dbl(pi))+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+"<span id='TPPC_"+prestation.getUid()+"'>"+coveragePct+"</span>"+sNegociate+"</td>";
					if(MedwanQuery.getInstance().getConfigInt("enableMFP",0)==1 && MedwanQuery.getInstance().getConfigString("MFP","0").equalsIgnoreCase(insurance.getInsurarUid())){
						prestationcontent+="<td>"+SH.getTotalPriceString(dbl(pbi))+"</td>";
					}
			        sNegociate="";
					if(sCoverageInsurance.length()>0){
			        ...
			        prestationcontent+="<td><input type='hidden' name='PPE_"+prestation.getUid()+"' id='PPE_"+prestation.getUid()+"' value='"+pc1+"'/><span id='TPPE_"+prestation.getUid()+"'>"+SH.getTotalPriceStringNoCurrency(dbl(pc1))+"</span> "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+sNegociate+"</td>";
			        ...
			        if(prestation!=null && prestation.getAnesthesiaPercentage()>0){
			        	...
			        	if(anesthesiaPrestation!=null){
			    	        ...
			    	        prestationcontent+="<td "+(sCoverageInsurance2.length()>0?"class='strikeonly'":"")+"><input type='hidden' name='PPP_"+anesthesiaPrestation.getUid()+"' value='"+pa+"'/>"+SH.getTotalPriceString(dbl(pa))+"</td>";
			    	        prestationcontent+="<td><input type='hidden' name='PPI_"+anesthesiaPrestation.getUid()+"' value='"+pi+"'/>"+SH.getTotalPriceString(dbl(pi))+coveragePct+"</td>";
			    			if(MedwanQuery.getInstance().getConfigInt("enableMFP",0)==1 && MedwanQuery.getInstance().getConfigString("MFP","0").equalsIgnoreCase(insurance.getInsurarUid())){
			    				prestationcontent+="<td>"+SH.getTotalPriceString(dbl(pbi))+"</td>";
			    			}
			    	        prestationcontent+="<td><input type='hidden' name='PPE_"+anesthesiaPrestation.getUid()+"' value='"+pc1+"'/>"+SH.getTotalPriceString(dbl(pc1))+"</td>";
			        ...
			        prestationcontent+="<td><font color='red'><b>"+SH.getTotalPriceString(dbl(pa))+"</font></td>";
			        prestationcontent+="<td><font color='red'><b>"+SH.getTotalPriceString(dbl(pi))+coveragePct+"</font></td>";
					if(MedwanQuery.getInstance().getConfigInt("enableMFP",0)==1 && MedwanQuery.getInstance().getConfigString("MFP","0").equalsIgnoreCase(insurance.getInsurarUid())){
						prestationcontent+="<td><font color='red'><b>"+SH.getTotalPriceString(dbl(pbi))+"</font></td>";
					}
			        prestationcontent+="<td><font color='red'><b>"+SH.getTotalPriceString(dbl(pc1))+"</font></td>";
				...
				if(!Prestation.checkMaximumReached(activePatient.personid, rule, quantity)){
			        ...
			        if(prestation!=null && prestation.getAnesthesiaPercentage()>0){
			        	...
			        	if(anesthesiaPrestation!=null){
			    	        ...
			    	        prestationcontent+="<td><input type='hidden' name='PPI_"+anesthesiaPrestation.getUid()+"' value='"+pi+"'/>"+SH.getTotalPriceStringNoCurrency(dbl(pi))+" "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+coveragePct+"</td>";
			    			if(MedwanQuery.getInstance().getConfigInt("enableMFP",0)==1 && MedwanQuery.getInstance().getConfigString("MFP","0").equalsIgnoreCase(insurance.getInsurarUid())){
			    				prestationcontent+="<td>"+SH.getTotalPriceString(dbl(pbi))+"</td>";
			    			}
			    	        prestationcontent+="<td><input type='hidden' name='PPE_"+anesthesiaPrestation.getUid()+"' value='"+pc1+"'/>"+SH.getTotalPriceStringNoCurrency(dbl(pc1))+" "+SH.cs("preferAlternateCurrency",SH.cs("currency","€"))+"</td>";
			    			sServiceName = sPrestationServiceName;
			    	        if(anesthesiaPrestation.getServiceUid()!=null && anesthesiaPrestation.getServiceUid().length()>0){
			    				Service service = Service.getService(anesthesiaPrestation.getServiceUid());
			    				if(service!=null){
