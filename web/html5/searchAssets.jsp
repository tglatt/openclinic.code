...
<%
	...
	while(rs.next()){
		out.println("<tr>");
		out.println("<td class='mobileadmin' "+(highlight.equalsIgnoreCase(rs.getInt("oc_asset_serverid")+"."+rs.getInt("oc_asset_objectid"))?"style='font-size:3vw;background-color: lightyellow'":"style='font-size:3vw;'")+">"+rs.getString("oc_asset_nomenclature").toUpperCase()+"</td>");
		...
		out.println("</tr>");
		out.println("<tr>");
		out.println("<td class='mobileadmin' "+(highlight.equalsIgnoreCase(rs.getInt("oc_asset_serverid")+"."+rs.getInt("oc_asset_objectid"))?"style='font-size:2vw;background-color: lightyellow'":"style='font-size:2vw;'")+">"+rs.getString("oc_asset_code").toUpperCase()+"</td>");
		out.println("</tr>");
	}
	rs.close();
	ps.close();
