...
<%=checkPermission(out,"hr.contract.edit","edit",activeUser)%>
...
<form name="EditForm" id="EditForm" method="POST">
    ...
    <table class="list" border="0" width="100%" cellspacing="1">            
        ...
        <%-- functionCode --%>
        <tr>
            <td class="admin"><%=getTran(request,"web.hr","stafftype",sWebLanguage)%></td>
            <td class="admin2">
                <select class="text" id="functionCode" name="functionCode">
                    <option/>
                    <%=ScreenHelper.writeSelect(request,"hr.contract.stafftype","",sWebLanguage)%>
                </select>
            </td>
        </tr>
                ...
                if(MedwanQuery.getInstance().getConfigString("enableLegalReferenceCode"+i).equals("1")){
                    %>                    
                        <tr>
                            ...
                            <td class="admin2">
                                <select class="text" id="ref<%=i%>" name="ref<%=i%>">
                                	<option/>
                                	<%=ScreenHelper.writeSelect(request, "hr.contractcode"+i, "", sWebLanguage) %>
                                </select>
                            </td>
                        </tr>
                    <%
        ...
        %>            
        <tr>
            <td class="admin"><%=getTran(request,"web.hr","councilnumber",sWebLanguage)%></td>
            <td class="admin2">
                <input type="text" class="text" id="ref3" name="ref3" size="20" maxLength="255" value="">
            </td>
        </tr>
            
        <tr>
            <td class="admin"><%=getTran(request,"web.hr","rnenumber",sWebLanguage)%></td>
            <td class="admin2">
                <input type="text" class="text" id="ref4" name="ref4" size="20" maxLength="255" value="">
            </td>
        </tr>
