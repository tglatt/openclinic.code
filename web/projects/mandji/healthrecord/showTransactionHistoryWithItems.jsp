	        ...
	        */
	        ...
	        while(itemElements.hasNext()){
	            ...
	            if(!sActif.equalsIgnoreCase("false")){
	                ...
	                if(sTranType.equalsIgnoreCase(sTmpTranTypeShort)){
	                    ...
	                    itemAndLabel = new ItemAndLabel(item,ScreenHelper.getTranNoLink(sLabelType,sLabelId,sWebLanguage),sOrder);
                ...
                <tr id="trTran<%=tranCount%>" style="display:none;">
                    <td colspan="6">
                        <table class="list" width="100%" cellspacing="1">                                            
                            ...
                            String sXmlFile = ScreenHelper.getConfigString("templateSource")+"historyItems.xml";
                            URL xmlUrl = new URL(sXmlFile);
                            SAXReader xmlReader = new SAXReader(false);
                            Document itemsDocument;
                            itemsDocument = xmlReader.read(xmlUrl);

                            Vector userSelectedItems = getHistoryItemsFromXML(itemsDocument,sTranTypeShort,sWebLanguage);
