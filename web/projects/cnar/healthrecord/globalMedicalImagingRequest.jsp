    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <script>writeMyDate("trandate","<c:url value="/_img/icons/icon_agenda.png"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            </td>
        ...
        <tr>
            ...
            <td class="admin2">
                <select id="examination" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_MIR2_TYPE" property="itemId"/>]>.value">
                    ...
                    %>
                    <%=ScreenHelper.writeSelect(request,"cnar_mir_type",sType,sWebLanguage,false,true)%>
                </select>
            </td>
            ...
            <%
                if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                    %>
                        ...
                        <%-- NIETS TE MELDEN --%>
                        <tr>
                            <td class="admin"><%=getTran(request,"Web.Occup",
        ...
        <tr>
            ...
            <td class="admin2" colspan="3">
                <input class="button" type="button" name="printLabelsButton" value="<%=getTran(null,"Web","printlabels",sWebLanguage)%>" onclick="printLabels();"/>&nbsp;
