        ...
        <%
            if(activeUser.getAccessRight("occup.medicalimagingrequest.execute.select")){
                %>
			        ...
			        <tr>
            			<td class="admin">
			            	<%=getTran(request,"web","filmused",sWebLanguage)%>
			            </td>
			        	<td colspan='3' class='admin2'>
			        		<table width='100%'>
			        			<tr>
			        				<td width='15%' style='text-align: right'>34x43 cm</td>
			        				<td width='5%'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_FILM1", 2, sWebLanguage) %></td>
			        				<td width='15%' style='text-align: right'>35x35 cm</td>
			        				<td width='5%'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_FILM2", 2, sWebLanguage) %></td>
			        				<td width='15%' style='text-align: right'>30x40 cm</td>
			        				<td width='5%'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_FILM3", 2, sWebLanguage) %></td>
			        				<td width='15%' style='text-align: right'>24x30 cm</td>
			        				<td width='5%'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_FILM4", 2, sWebLanguage) %></td>
			        				<td width='15%' style='text-align: right'>18x24 cm</td>
			        				<td width='5%'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_FILM5", 2, sWebLanguage) %></td>
			        			</tr>
			        		</table>
			        	</td>
			        </tr>
