									...
									if(insurar.getContact().equalsIgnoreCase("plan.openinsurance")){
	                                    ...
	                                    %>
	                                        <tr class="list<%=sClass%>" onmouseover="this.style.cursor='hand';" onmouseout="this.style.cursor='default';">
	                                            <td>
	                                                <a href="#" onclick="deleteInsurar('<%=insurar.getUid()%>');"><img src='<c:url value="/_img/icons/icon_delete.png"/>' border='0' alt="<%=sTranDelete%>"></a>
	                                            </td>
...
<script>
  ...
  function addCategoryToTable(catName,catLabel,catPatientShare,catuid){
    if(!allreadySelected(catName)){
      ...
      row.cells[0].innerHTML = "<a href='#' onclick='deleteCategory(rowCategory"+iIndexCategories+");'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web","delete",sWebLanguage)%>' border='0'></a>&nbsp;"+
                               "<a href='#' onclick='editCategory(rowCategory"+iIndexCategories+");'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web","edit",sWebLanguage)%>' border='0'></a>&nbsp;";
  ...
  function updateCategory(){
    if(isAtLeastOneCategoryFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='#' onclick='deleteCategory("+editCategoryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTran(null,"web","delete",sWebLanguage)%>' border='0'></a> "+
                               "<a href='#' onclick='editCategory("+editCategoryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTran(null,"web","edit",sWebLanguage)%>' border='0'></a>";
