...
<%
	...
	out.println("<tr class='admin'><td colspan='1'><b>"+getTran(request,"web","visits",sWebLanguage)+"</b></td><td colspan='4'><b>"+
			getTran(request,"web","period",sWebLanguage)+": "+sBegin+" - "+sEnd+"</b></td></tr>");
	while(rs.next()){
	...
	out.println("<tr><td colspan='5'><b>"+getTran(request,"web","totalpatients",sWebLanguage)+": "+counter+"</b></td></tr>");
	rs.close();
	ps.close();
	oc_conn.close();
%>
