...
<table width="100%">
	...
	<tr>
		...
		<td colspan='1' nowrap><%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO) transaction, "ITEM_TYPE_BIOMETRY_GLYCEMIA", 5) %> g/dl</td>
		<td width='1%' nowrap><b><%=getTran(request,"web","perimetrecranien",sWebLanguage) %></b></td>
			<td nowrap>
				<%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_PERIMETRE_CRANIEN", 5, 10, 150, sWebLanguage) %> cm
			</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td nowrap colspan='2'><%=SH.writeDefaultNumericInput(session, tran, "[GENERAL.ANAMNESE]ITEM_TYPE_RESPIRATORY_FRENQUENCY", 5, 0, 100, sWebLanguage) %> /min</td>
