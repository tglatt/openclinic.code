...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +"<tr><td class='admin'>"+getTran(request,"web","zone",sWebLanguage)+"</td><td class='admin2'>"+sDistricts+"</td></tr>"
              +"<tr><td class='admin'>"+getTran(request,"web","district",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
              +inputRow(request,"Web","wordea","PAddress","AdminPrivate",apc.address,"T",true, true,sWebLanguage)
              +inputRow(request,"Web","katena","PCity","AdminPrivate",apc.city,"T",true,false,sWebLanguage)
              +inputRow(request,"Web","kebele","PQuarter","AdminPrivate",apc.quarter,"T",true,false,sWebLanguage)
