...
<table width='100%' cellspacing="1" class="list">
	<%
		int nBloodGifts=0;
		try{
			nBloodGifts=MedwanQuery.getInstance().getTransactionsByType(Integer.parseInt(activePatient.personid), "be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_CNTS_BLOODGIFT").size();
		}
		catch(Exception e){}
	%>
    <%=(
