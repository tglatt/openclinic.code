...
<!-- 
 ...
 -->
<%
	String accessright="msas.registryBIOPALU";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
		...
		<tr>    
	         ...
	         <td class="admin2"><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_REGISTRY_BIO_PALU_SERVICE",40, 2)%></td>
	         <td class="admin2" colspan="2">
			    <%=SH.writeDefaultRadioButtons(tran,request, "provenance","ITEM_TYPE_MSAS_REGISTRY_BIO_PALU_PROVENANCE" ,sWebLanguage,true,"", "")%>
			</td>
	    </tr>
	    <tr>
			<td class="admin"><%=getTran(request,"web","examendemande",sWebLanguage)%>&nbsp;</td>
	        <td class="admin2" colspan='4'>
	       		 <%=SH.writeDefaultCheckBoxes(tran, request, "examendemande", "ITEM_TYPE_MSAS_REGISTRY_BIO_PALU_EXAMEN", sWebLanguage, true) %>
	        </td>
         </tr>
	    <tr>      
	         <td class="admin"><%=getTran(request,"web","resultats",sWebLanguage)%></td>
	         <td class="admin2"><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_REGISTRY_BIO_PALU_RESULTATS",40, 2)%></td>
	         <td class="admin"><%=getTran(request,"web","observation",sWebLanguage)%></td>
	         <td class="admin2"><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_REGISTRY_BIO_PALU_OBSERVATIONS",40, 2)%></td>
  	</tr>	
