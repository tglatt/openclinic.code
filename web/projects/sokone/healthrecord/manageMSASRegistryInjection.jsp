...
<!-- 
 ...
 -->
<%
	String accessright="msas.injection";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <% TransactionVO tran = (TransactionVO)transaction; %>
  		 ...
  		 <tr class='admin'><td colspan='4'><%=getTran(request,"web","injection",sWebLanguage) %></td></tr> 
	     <tr>
           	 <td class="admin" > <%=getTran(request,"web","voieadministration",sWebLanguage)%></td>
            <td class="admin2" colspan='4' > <%=SH.writeDefaultRadioButtons(tran,request, "voieadministration","ITEM_TYPE_MSAS_INJECTION_VOIE_ADMINISTRATION" ,sWebLanguage,true,"", "")%></td>
   		<tr>        
	     <tr>         
             <td class="admin" > <%=getTran(request,"web","produit",sWebLanguage)%></td>
            <td class="admin2"> <%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_INJECTION_PRODUIT",40, 2)%></td>
             <td class="admin" > <%=getTran(request,"web","observation",sWebLanguage)%></td>
            <td class="admin2"> <%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_MSAS_INJECTION_OBSERVATION",40, 2)%></td>   
  		</tr>	
    </table>
