...
<%
    String sGender = "&nbsp;", sComment = "&nbsp;", sNativeCountry = "&nbsp;", sLanguage = "&nbsp;", sNatreg = "&nbsp;", sVip="0"
            , sCivilStatus = "&nbsp;", sTracnetID = "&nbsp;", sTreatingPhysician = "&nbsp;", sComment3="", sComment4="", sDeathCertificateTo="", sDeathCertificateOn="", sExport="0", sLastExport="0";
    ...
    if ((activePatient.comment4!=null)&&(activePatient.comment4.trim().length()>0)) {
        sComment4 = (activePatient.getReceiverPersonIdsToHtmlTable(sWebLanguage));
    }
