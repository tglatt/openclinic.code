...
<form name="searchForm" method="post">
	...
	<table width="100%" class="menu" cellspacing="0" cellpadding="1">
		<tr>
			<td class='admin' width="1%" nowrap><%=getTran(request,"web.accountancy","client.prefix",sWebLanguage)%>&nbsp;</td>
		...
		<tr>
			<td class='admin'><%=getTran(request,"web.accountancy","supplier.prefix",sWebLanguage)%>&nbsp;</td>
