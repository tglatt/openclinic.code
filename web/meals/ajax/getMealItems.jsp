			...
			<table class="list" width="100%" cellspacing="1" cellpadding="1" onKeyDown="if(enterEvent(event,13)){searchMealItemsWindow();return false;}">
			    ...
			    <tr>
			        ...
			        <td class="admin2">
			            ...
			            <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="clearMealItemSearchFields();">			      
			        </td>
			    </tr>
			</table>
			<br>  
