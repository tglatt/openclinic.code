...
<%@include file="/includes/validateUser.jsp"%><%@page errorPage="/includes/error.jsp"%><%
        ...
        try{
            ...
            PDFProductStockLabelGenerator pdfProductStockLabelGenerator = new PDFProductStockLabelGenerator(activeUser,sProject);
            baosPDF = pdfProductStockLabelGenerator.generatePDFDocumentBytes(request,productStock);
