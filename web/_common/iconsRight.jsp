...
<%
    ...
    for(int i=0; i<userParameters.size(); i++){
        ...
        ///////////////////////////////////////////////////////////////////////
       	*/
       	...
       	if(SH.c(sLongLabelId).startsWith("hidden.clinicalDocuments$")){
    ...
    if(activePatient!=null && "1".equalsIgnoreCase(""+activePatient.adminextends.get("vip")) && !activeUser.getAccessRight("vipaccess.select")){
        // empty
    }
    else{
        %>
        ...
        if(SH.ci("enablePatientTracking",0)==1){
            %><img style='cursor:pointer;padding: 0px 2px 0px;vertical-align: top' onclick="clickMenuItem('javascript:showPatientTracking();');" title="<%=getTranNoLink("Web","patienttracking",sWebLanguage)%>" height='16px' src="<c:url value='/_img/icons/mobile/bluetooth.png'/>"/><%
        }
