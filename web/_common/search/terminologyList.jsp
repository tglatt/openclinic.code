        ...
        if(vTerminologies.size() > 0){
            ...
            while(termIter.hasNext()){
                ...
                sbResults.append("<tr class='list"+sClass+"' onmouseover='this.className=\"list_select\";' onmouseout='this.className=\"list"+sClass+"\";'>")
		                  .append("<td>")
		                   .append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png'/ alt='"+getTranNoLink("web","delete",sWebLanguage)+"' class='link' onclick=\"doDelete('"+tObj.getUid()+"');\">")
		                   .append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png'/ alt='"+getTranNoLink("web","edit",sWebLanguage)+"' class='link' onclick=\"doEdit('"+tObj.getUid()+"');\">")
		                  .append("</td>")
