...
<%
	...
	String sql="select * from nupsref where 1=1";
	if(section.length()>0){
	...
	while(rs.next()){
		n++;
		out.println("<tr><td class='admin'><a style='font-weight: bolder;color: darkblue' href='javascript:selectNUPS(\""+rs.getString("nups")+"\")'>"+rs.getString("nups")+"</a>&nbsp;</td><td class='admin' nowrap>"+rs.getString("section")+"&nbsp;</td><td class='admin2'>"+rs.getString(sWebLanguage).toUpperCase()+"</td></tr>");
	}
	if(n>999){
