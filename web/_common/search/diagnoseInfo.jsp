    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                <%
                    ...
                    flags = Diagnosis.getFlags(sType.equalsIgnoreCase("icpc")?"ICPC":"ICD10",sFindCode,flags);
                    SH.syslog("sType: "+sType);
                    SH.syslog("sFindCode: "+sFindCode);
                    SH.syslog("flags: "+flags);
        ...
        %>
            ...
            <tr>
                ...
                <td class="admin2">
                    <input type="radio" name="suspected" id="suspected" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input type="radio" name="suspected" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
        ...
        %>
            <%-- severe --%>
            <tr>
                <td class="admin" nowrap><%=getTran(request,"medical.diagnosis","lostconscience",sWebLanguage)%> *</td>
                <td class="admin2">
                    <input type="radio" name="conscience" id="conscience" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input type="radio" name="conscience" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
        ...
        %>
            <%-- chronic --%>
            <tr>
                <td class="admin" nowrap><%=getTran(request,"medical.diagnosis","sampled",sWebLanguage)%> *</td>
                <td class="admin2">
                    <input type="radio" name="sampled" id="sampled" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input type="radio" name="sampled" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
        ...
        %>
            <%-- major --%>
            <tr>
                <td class="admin" nowrap><%=getTran(request,"medical.diagnosis","major",sWebLanguage)%> *</td>
                <td class="admin2">
                    <input type="radio" name="major" id="major" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input type="radio" name="major" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
        ...
        %>
            <%-- minor --%>
            <tr>
                <td class="admin" nowrap><%=getTran(request,"medical.diagnosis","minor",sWebLanguage)%> *</td>
                <td class="admin2">
                    <input type="radio" name="minor" id="minor" value="medwan.common.true"/><%=getTran(request,"web","yes",sWebLanguage)%>
                    <input type="radio" name="minor" value="medwan.common.false"/><%=getTran(request,"web","no",sWebLanguage)%>
                </td>
            </tr>
        <%
            }
...
<script>
  ...
  function doAdd(){
    ...
    if(certainty.length==0){
      ...
      if(document.getElementById('conscience')){
      ...
      if(document.getElementById('sampled')){
          if(document.getElementById('sampled').checked){
  	      flags+= "Q";
  	    }
  	    else{
  	      flags+= "q";
      ...
      if(document.getElementById('suspected')){
          if(document.getElementById('suspected').checked){
  	      flags+= "W";
  	    }
  	    else{
  	      flags+= "w";
