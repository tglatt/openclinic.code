    ...
    <%
        ...
        out.print(
                ...
                +normalRow("Web.socsec","assurancetype","SAssurancetype","AdminSocSec",sWebLanguage)
                        ...
                        +"</select></td></tr>"
                +inputRow(request,"Web","start","SStart","AdminSocSec",socsec.start,"D",true,false,sWebLanguage)
                +inputRow(request,"Web","stop","SStop","AdminSocSec",socsec.stop,"D",true,false,sWebLanguage)
                +inputRow(request,"Web","comment","SComment","AdminSocSec",socsec.comment,"T",true, true,sWebLanguage));
    %>
    <%-- spacer --%>
    <tr height="0">
