...
<%!
    ...
    private String addFR(int iTotal, String sourceId, String destinationId, String relationType,
        ...
        if(sourceId.equals(activePatient.personid)){
        	buf.append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' onclick=\"deleteFR(rowFR"+iTotal+");\" class='link' alt='").append(getTranNoLink("Web","delete",sWebLanguage)).append("'>");
        }        
            ...
            <table width="100%" cellspacing="1" class="list">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="doSearchPatient('RDestinationId','RDestinationFullName');">
                        <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="PatientEditForm.RDestinationId.value='';PatientEditForm.RDestinationFullName.value='';">
                    </td>
                </tr>
              ...
              function addFR(){
                ...
                if(destinationId.length > 0 && PatientEditForm.RRelationType.selectedIndex > 0){
                  ...
                  // add
                      ...
                      row.cells[0].innerHTML = "<center><a href='javascript:deleteFR(rowFR"+iIndexFR+");'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web","delete",sWebLanguage)%>' border='0'></a></center>";
