...
<%
	...
	if(bRejected){
		out.println("<font style='font-size: 14px;color: red'>"+ScreenHelper.getTran(request,"cnts","patientpermanentlyrejected",language)+"</font>");
	}
	else {
		out.println("<font style='font-size: 14px'>"+ScreenHelper.getTran(request,"cnts","notrejected",language)+"</font>");
	}
%>