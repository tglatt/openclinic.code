...
<table width='100%'>
	<tr class='admin'><td colspan='5'><%=getTran(request,"web","hemovigilance",sWebLanguage) %></td></tr>
	<tr class='admin'>
		...
		<td><%=getTran(request,"cnts","pocket",sWebLanguage) %></td>
...
<%
	...
	while(rs.next()){
		...
		if(transactionVO!=null){
			...
			out.println("<td class='admin2'>"+rs.getString("oc_hemovigilance_pocketnumber")+"</td>");
