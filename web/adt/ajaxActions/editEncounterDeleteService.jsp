    ...
    if(tmpEncounter!=null){
        ...
        if(transferHistory.size() > 0){
	        ...
	        for(int n=0; n<transferHistory.size(); n++){
		        ...
		        %>
				    <tr>
				        <td width="25"><img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","delete",sWebLanguage)%>" onclick="deleteService('<%=encounterService.serviceUID%>')"></td>
