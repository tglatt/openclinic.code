...
<table width='100%'>
	...
	<tr>
		<td style='text-align: center;font-size: 12px'>
			<%=getTran(request,"web","malriaseverity",sWebLanguage) %><BR/>
...
<script>
	...
	function <%=prefix%>showDetails(){
		openPopup('dashboards/<%=prefix%>/getDetails.jsp&language=<%=sWebLanguage%>',500,300,'<%=getTranNoLink("web","malriaseverity",sWebLanguage)%>');
	}
