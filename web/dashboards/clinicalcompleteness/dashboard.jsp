...
<table width='100%'>
	<tr>
		<td style='text-align: center'>
			<%=writeDashboardGauge(prefix+"gauge",200,0,500,"% Volume clinique")%><br/>
...
<script>
	...
	gauge_setStaticZones(<%=prefix%>gauge,[{strokeStyle: "red", min: 0, max: 75},{strokeStyle: "yellow", min: 75, max: 100},{strokeStyle: "lightgreen", min: 100, max: 500}]);
