        ...
        %>
            ...
            <table width="100%" class="list" cellspacing="1">
                ...
                <% 	if(MedwanQuery.getInstance().getConfigInt("enableDHIS2",0)==1){ %>
	                ...
	                <tr>
	                    ...
	                    <td class="admin2">
                        	<input type="text" class="text" name="EditServiceInscode" value="<%=Pointer.getPointer("dhis2.orgunitid."+service.code)%>" size="<%=sTextWidth%>">
	                    </td>
	                </tr>
                <% 	}
                   	else{
            ...
            <script>
              ...
              function validateCode(){
            	  if(document.getElementById("EditServiceCode").value.length>0 && document.getElementById("EditOldServiceCode").value.toLowerCase()!=document.getElementById("EditServiceCode").value.toLowerCase()){
