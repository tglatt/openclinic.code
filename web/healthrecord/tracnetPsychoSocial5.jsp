	...
	<tr>
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.autre.soutien.communautaires",sWebLanguage)%>	
					</td>
				</tr>
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.services.communautaires",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.services.communautaires.oui",sWebLanguage)%>
					</td>
					<td class="admin2">
		...
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.notes.apres.evaluation",sWebLanguage)%>	
					</td>
				</tr>
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.conclusion.première.séance",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.obstacles.adhérence.counsellor",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.questions.problèmes.spécifique.patient",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>		
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.orientations",sWebLanguage)%>
					</td>
					<td class="admin2">
