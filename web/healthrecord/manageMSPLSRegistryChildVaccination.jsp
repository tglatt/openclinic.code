...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin"><%=getTran(request,"web", "rts", sWebLanguage)%></td>
            <td class="admin2">
		...
		<tr>
		           <td class="admin"><%=getTran(request,"web", "cpp", sWebLanguage)%></td>
		           <td class="admin2">
		           	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_CPP", "mspls.vacc.cpp", sWebLanguage, "") %>
		           </td>
		       </tr>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "mildaa18mois", sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
        	...
        	<td class='admin2'>
        		<%= SH.writeDefaultDateInput(session, (TransactionVO)transaction, "ITEM_TYPE_DATE_PROCHAINRENDEZVOUS", sWebLanguage, sCONTEXTPATH) %>
        		<a href="javascript:openPopup('planning/findPlanning.jsp&amp;skipEmpty=1',900,400,'medication');void(0);"><%=getTran(request,"Web.Occup","vaccination.planning",sWebLanguage)%></a>
        	</td>
        </tr>
        <tr>
