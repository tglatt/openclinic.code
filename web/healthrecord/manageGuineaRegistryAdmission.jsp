...
<!-- 
 ...
 -->
<%
	String accessright="mshp.admission";
%>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
            ...
            <td class='admin2' colspan="3">
				<%=SH.writeDefaultSelect(request, tran, "!ITEM_TYPE_SERVICE", SH.cs("admission.service.type","admission.service"), sWebLanguage, "") %>
            </td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","entrytype",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "!ITEM_TYPE_ENTRYTYPE", "gn.admission.entrytype", sWebLanguage, "") %></td>
