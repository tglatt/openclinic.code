...
<%
    String permissionCheckFU = checkPermission(out,"occup.medicalimagingrequest_fixedunit","",activeUser),
           permissionCheckMU = checkPermission(out,"occup.medicalimagingrequest_mobileunit","",activeUser);
