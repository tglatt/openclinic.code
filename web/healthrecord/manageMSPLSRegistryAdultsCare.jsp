            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						...
						<td width='20%'><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HB","mspls.labresult", sWebLanguage, "") %> <%=getTran(request,"web","hemoglobine",sWebLanguage) %> <%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_HBTEXT",5,1,50,sWebLanguage) %>g/dl </td>
