	...
	<tr>
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr class="admin">
					<td colspan="2">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.connaissance.maladie",sWebLanguage)%>	
					</td>
				</tr>
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.vih.sida",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>
					...
					<td class="admin2">
						...
						<div id="service_arv_oui_block" style="display:none">
							<br/><br/>
							<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.services.arv.oui.suivi",sWebLanguage)%>
							<br/>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.reaction",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.trois.personnes.plu.proches.révélé.tableau",sWebLanguage)%>
					</td>
					<td class="admin2">
						<table cellpadding="0" cellspacing="1" border="1">
							<tr class="admin">
								<td colspan="2">
									<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.personne",sWebLanguage)%> 1
								</td>
							</tr>
							<tr>
								<td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.reaction.nom",sWebLanguage)%></td>
								<td class="admin2">
							...
							<tr>	
								<td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.reaction.relation",sWebLanguage)%></td>
								<td class="admin2">
						...
						<table cellpadding="0" cellspacing="1" border="1">	
							<tr class="admin">
								<td colspan="2">
									<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.personne",sWebLanguage)%> 2
								</td>
							</tr>
							<tr>
								<td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.reaction.nom",sWebLanguage)%></td>
						...
						<table cellpadding="0" cellspacing="1" border="1">
							<tr class="admin">
								<td colspan="2">
									<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.personne",sWebLanguage)%> 3
								</td>
							</tr>	
							<tr>
								<td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.reaction.nom",sWebLanguage)%></td>
				...
				<tr>
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.pas.révélé.statut.proches",sWebLanguage)%>
					</td>
					<td class="admin2">
		...
		<td width="50%" style="vertical-align:top;">
			<table width="100%" cellspacing="1" cellpadding="0">
				...
				<tr id="choisi_parrain1" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.nom.prenom.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="choisi_parrain2" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.age.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="choisi_parrain3" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.sexe.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="choisi_parrain4" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
						<table>
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine.province",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine.district",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine.secteur",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td><%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine.cellule",sWebLanguage)%></td>
								<td>
							...
							<tr>
								<td colspan="2">
									<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.résidence.parrain.marraine.trop.loin",sWebLanguage)%>
								</td>
							</tr>
							<tr>
								<td colspan="2">
				...
				<tr id="choisi_parrain5" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.parrain.marraine.téléphone",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="choisi_parrain6" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.parrain.marraine.contact",sWebLanguage)%>
					</td>
					<td class="admin2">
				...
				<tr id="choisi_parrain7" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.instruction.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select id="parrain7" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PARRAIN_MARRAINE_INSTRUCTION" property="itemId"/>]>.value">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.niveau.instruction",sType,sWebLanguage,false,true)%>
		                </select>
					</td>
				</tr>
				<tr id="choisi_parrain8" style="display:none;">
					<td class="admin" width="<%=sTDAdminWidth%>">
						<%=getTran(request,"openclinic.chuk","tracnet.psychosocial.profession.parrain.marraine",sWebLanguage)%>
					</td>
					<td class="admin2">
						<select id="parrain_instruction" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PARRAIN_MARRAINE_PROFESSION" property="itemId"/>]>.value" onchange="checkPage4Settings();">
		                    ...
		                    %>
		                    <%=ScreenHelper.writeSelect(request,"tracnet.profession",sType,sWebLanguage,false,true)%>
		                </select><br/>
