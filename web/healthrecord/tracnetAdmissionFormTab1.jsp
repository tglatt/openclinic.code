...
<%!
    private StringBuffer addChildren(int iTotal,String sAge,String sAdopt,String sTest, String sResult, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowChildren"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteChildren(rowChildren"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editChildren(rowChildren"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
    ...
    private StringBuffer addARV(int iTotal,String sMolecule,String sDuration,String sComment, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowARV"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteARV(rowARV"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editARV(rowARV"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
   ...
   private StringBuffer addAntecedents(int iTotal,String sMolecule,String sDateBegin,String sDateEnd, String sComment, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowAntecedents"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteAntecedents(rowAntecedents"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editAntecedents(rowAntecedents"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
             .append("<td class='admin2'>&nbsp;" + sTmpMolecule + "</td>")
...
<script>
  ...
  function addChildren(){
    if(isAtLeastOneChildrenFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteChildren(rowChildren"+iChildrenIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editChildren(rowChildren"+iChildrenIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateChildren(){
    if(isAtLeastOneChildrenFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteChildren("+editChildrenRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editChildren("+editChildrenRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
 ...
 function addARV(){
    if(isAtLeastOneARVFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteARV(rowARV"+iARVIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editARV(rowARV"+iARVIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateARV(){
    if(isAtLeastOneARVFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteARV("+editARVRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editARV("+editARVRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addAntecedents(){
    if(isAtLeastOneAntecedentsFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteAntecedents(rowAntecedents"+iAntecedentsIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editAntecedents(rowAntecedents"+iAntecedentsIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateAntecedents(){
    if(isAtLeastOneAntecedentsFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteAntecedents("+editAntecedentsRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editAntecedents("+editAntecedentsRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
