...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
            	<select onchange="setExpiryDate(this,'cntspfcexpirydate',<%=SH.ci("cntspfcexpirationdays",365) %>);checkPharmacyLink('pfc','pfcdiv');" class='text' id="pfcpockets" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNTSLAB_PFCPOCKETS" property="itemId"/>]>.value">
        ...
        <tr>
            ...
            <td class="admin2">
            	<select onchange="setExpiryDate(this,'cntsprpexpirydate',<%=SH.ci("cntsprpexpirationdays",5) %>);checkPharmacyLink('prp','prpdiv');" class='text' id="prppockets" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNTSLAB_PRPPOCKETS" property="itemId"/>]>.value">
        ...
        <tr>
            ...
            <td class="admin2">
            	<select onchange="setExpiryDate(this,'cntscgrexpirydate',<%=SH.ci("cntscgrexpirationdays",35) %>);checkPharmacyLink('cgr','cgrdiv');" class='text' id="cgrpockets" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNTSLAB_CGRPOCKETS" property="itemId"/>]>.value">
...
<script>
  ...
  function setExpiryDate(source,fieldname,days){
	  if(document.getElementById("cntsobjectid").value.trim().length==0){
		  alert('<%=getTranNoLink("web","selectbloodgiftfirst",sWebLanguage)%>');
		  source.value='0';
	  }
	  else{
