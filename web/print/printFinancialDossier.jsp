...
<form name="printForm" id="printForm" method="POST">
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            <td class="admin">
                <input type="checkbox" name="section_4" id="section_4" value="on" class="hand" <%=(sSection4.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","activeInsuranceData",sWebLanguage,"section_4")%>
            </td>
        </tr>
        ...
        <tr>
            <td class="admin">
                <input type="checkbox" name="section_5" id="section_5" value="on" class="hand" <%=(sSection6.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","historicalInsuranceData",sWebLanguage,"section_5")%>
            </td>
        </tr>
        ...
        <tr>
            <td class="admin">
                <input type="checkbox" name="section_6" id="section_6" value="on" class="hand" <%=(sSection6.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","patientInvoices",sWebLanguage,"section_6")%>
            </td>
        </tr>
        ...
        <tr>
            <td class="admin">
                <input type="checkbox" name="section_7" id="section_7" value="on" class="hand" <%=(sSection6.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","patientPayments",sWebLanguage,"section_7")%>
            </td>
        </tr> 
        ...
        <tr>
            <td class="admin">
                <input type="checkbox" name="section_8" id="section_8" value="on" class="hand" <%=(sSection7.equals("on")?"CHECKED":"")%>><%=getLabel(request,"pdf","signature",sWebLanguage,"section_8")%>
            </td>
        </tr>
        --%> 
