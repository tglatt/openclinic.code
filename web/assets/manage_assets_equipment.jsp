    ...
    <table class="list" border="0" width="100%" cellspacing="1">    
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                &nbsp;&nbsp;<img style='vertical-align:middle' src='<%=sCONTEXTPATH %>/_img/icons/icon_barcode.gif' onclick='printBarcode("<%=asset.getUid()%>","<%=asset.getServiceuid()+"_"+asset.getDescription().replace("\"","&apos;").replace("'","&apos;")%>");'/>
            </td>
		</tr>
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="text" class="text" id="purchasePrice" name="purchasePrice" size="15" maxLength="15" value="<%=new DecimalFormat(SH.cs("priceFormat", "#")).format(asset.getPurchasePrice()) %>" onKeyUp="isNumber(this);" onBlur="if(isNumber(this))setDecimalLength(this,2,true);">
...
<script>
	...
	function printBarcode(id,name){
		window.open("<%=sCONTEXTPATH%>/assets/printBarcode.jsp?id="+id+"&name="+name);
	}
