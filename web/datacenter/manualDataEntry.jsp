...
<div class='landlist' >
    <h3><%=getTran(request,"datacenter","manual.data.entry",sWebLanguage)%></h3>
    ...
    <form name='transactionForm' id="transactionForm" method='POST'>
       ...
       <div class='subcontent'>
        <table width="100%" class="content" cellpadding="0" cellspacing="0">
            <tr>
                <td class='admin' colspan='2'><%=getTran(request,"datacenter","core",sWebLanguage)%></td>
            </tr>
            <tr>
                <td class='admin'><%=getTran(request,"datacenter","date.core",sWebLanguage)%></td>
