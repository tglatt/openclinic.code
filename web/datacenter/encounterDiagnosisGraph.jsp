...
<script>
    setGraph(<%=sJsArray%>);
    Modalbox.setTitle("<%=HTMLEntities.htmlentities(getTran(request,"datacenterserver", serverId + "", sWebLanguage)+"<br/>"+code+" "+MedwanQuery.getInstance().getCodeTran("ICD10Code"+code,sWebLanguage)+" ("+getTranNoLink("web",type,sWebLanguage)+")")%>");
</script>